...
## If i2c has been installed into a location defferent form prefix or /usr;
...
#%define kversion 2.2.14-SMP

%define name lm_sensors
%define I2C_HEADERS %{prefix}
%define ver 2.4.5
...
###Latest RedHat distributions define a different Group:
...
%doc FAQ cvs fan-divisors modules progs temperature-sensors
%doc useful_addresses.html version-2
