...
static sensors_chip_feature lm90_features[] =
  {
    ...
    { SENSORS_LM90_LOCAL_TCRIT, "tcrit1",
      SENSORS_LM90_LOCAL_TEMP, SENSORS_LM90_LOCAL_TEMP,
      RW, LM90_SYSCTL_LOCAL_TCRIT, VALUE(1), 0 },
...
/* swap 5 and 6 min/max because compute lines will be inverting */
    ...
    { SENSORS_W83781D_FAN1_DIV, "fan1_div", SENSORS_W83781D_FAN1, 
                         NOMAP, RW, 
                         W83781D_SYSCTL_FAN_DIV, VALUE(1), 0, "fan_div1" },
    { SENSORS_W83781D_FAN2_DIV, "fan2_div", SENSORS_W83781D_FAN2, 
                         NOMAP, RW, 
                         W83781D_SYSCTL_FAN_DIV, VALUE(2), 0, "fan_div2" },
    { SENSORS_W83781D_FAN3_DIV, "fan3_div", SENSORS_W83781D_FAN3, 
                         NOMAP, RW, 
                         W83781D_SYSCTL_FAN_DIV, VALUE(3), 0, "fan_div3" },
    ...
    { SENSORS_W83781D_BEEPS, "beeps", SENSORS_W83781D_ALARMS,
                         ...
                         W83781D_SYSCTL_BEEP, VALUE(2), 0, "beep_mask" },
    { 0 }
  };
...
static sensors_chip_feature asb100_features[] = { 
	...
	{ SENSORS_ASB100_BEEP_ENABLE, "beep_enable", SENSORS_ASB100_ALARMS,
		NOMAP, RW,
		ASB100_SYSCTL_BEEP, VALUE(1), 0 },
	{ SENSORS_ASB100_BEEPS, "beeps", SENSORS_ASB100_ALARMS,
		SENSORS_ASB100_ALARMS, RW,
		ASB100_SYSCTL_BEEP, VALUE(2), 0 },
	{ 0 }
};
...
static sensors_chip_feature w83783s_features[] =
  { 
    ...
    { SENSORS_W83783S_FAN3_MIN, "fan3_min", SENSORS_W83783S_FAN3, 
                        ...
                        W83781D_SYSCTL_FAN3, VALUE(1), 0 },
    { SENSORS_W83783S_TEMP1, "temp1", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_TEMP1, VALUE(3), 1 },
    ...
    { SENSORS_W83783S_TEMP1_OVER, "temp1_over", SENSORS_W83783S_TEMP1,
                         SENSORS_W83783S_TEMP1, RW, 
                         W83781D_SYSCTL_TEMP1, VALUE(1), 1 },
    { SENSORS_W83783S_TEMP2, "temp2", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_TEMP2, VALUE(3), 1 },
...
static sensors_chip_feature via686a_features[] =
  { 
    { SENSORS_VIA686A_IN0, "2.0V", NOMAP, NOMAP, 
                        R, VIA686A_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_VIA686A_IN1, "2.5V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_VIA686A_IN2, "3.3V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_VIA686A_IN3, "5.0V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_VIA686A_IN4, "12V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN4, VALUE(3), 2 },
    ...
    { SENSORS_VIA686A_ALARMS, "alarms", NOMAP, NOMAP, 
                           R, VIA686A_SYSCTL_ALARMS, VALUE(1), 0 },
    { 0 }
  };
...
static sensors_chip_feature it87_features[] =
  {
    ...
    { SENSORS_IT87_ALARMS, "alarms", NOMAP, NOMAP,
                           R, IT87_SYSCTL_ALARMS, VALUE(1), 0 },
...
static sensors_chip_feature fscscy_features[] =
  ...
  static sensors_chip_feature fscher_features[] =
  {
    ...
    { SENSORS_FSCHER_FAN1, "fan1", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_FAN0, VALUE(4), 0 },
    { SENSORS_FSCHER_FAN2, "fan2", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_FAN1, VALUE(4), 0 },
    { SENSORS_FSCHER_FAN3, "fan3", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_FAN2, VALUE(4), 0 },
    { SENSORS_FSCHER_FAN1_MIN, "fan1_min", SENSORS_FSCHER_FAN1, 
			SENSORS_FSCHER_FAN1, RW, 
			FSCHER_SYSCTL_FAN0, VALUE(2), 0 },
    { SENSORS_FSCHER_FAN2_MIN, "fan2_min", SENSORS_FSCHER_FAN2, 
			SENSORS_FSCHER_FAN2, RW, 
			FSCHER_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_FSCHER_FAN3_MIN, "fan3_min", SENSORS_FSCHER_FAN3, 
...
static sensors_chip_feature vt1211_features[] =
  { 
    ...
    { SENSORS_VT1211_IN6, "in6", NOMAP, NOMAP,
                        R, VT1211_SYSCTL_IN6, VALUE(3), 2 },
    ...
    { SENSORS_VT1211_IN6_MIN, "in6_min", SENSORS_VT1211_IN6,
                            SENSORS_VT1211_IN6,
                            RW, VT1211_SYSCTL_IN6, VALUE(1), 2 },
    ...
    { SENSORS_VT1211_IN6_MAX, "in6_max", SENSORS_VT1211_IN6,
                            SENSORS_VT1211_IN6,
                            RW, VT1211_SYSCTL_IN6, VALUE(2), 2 },
    ...
    { SENSORS_VT1211_TEMP, "temp1", NOMAP, NOMAP,
                         R, VT1211_SYSCTL_TEMP, VALUE(3), 1 },
    { SENSORS_VT1211_TEMP_HYST, "temp1_hyst", SENSORS_VT1211_TEMP,
                              SENSORS_VT1211_TEMP, RW, 
...
static sensors_chip_feature vt8231_features[] =
  { 
    ...
    { SENSORS_VT8231_IN6, "in6", NOMAP, NOMAP,
                        R, VT8231_SYSCTL_IN6, VALUE(3), 2 },
    ...
    { SENSORS_VT8231_IN6_MIN, "in6_min", SENSORS_VT8231_IN6,
                            SENSORS_VT8231_IN6,
                            RW, VT8231_SYSCTL_IN6, VALUE(1), 2 },
    ...
    { SENSORS_VT8231_IN6_MAX, "in6_max", SENSORS_VT8231_IN6,
                            SENSORS_VT8231_IN6,
                            RW, VT8231_SYSCTL_IN6, VALUE(2), 2 },
