...
static sensors_chip_feature lm87_features[] =
  { 
    ...
    { SENSORS_LM87_FAN1_MIN, "fan1 min", SENSORS_LM87_FAN1,
                        SENSORS_LM87_FAN1, SENSORS_MODE_RW, 
                        LM87_SYSCTL_FAN1, VALUE(1), 0 },
    { SENSORS_LM87_FAN2_MIN, "fan2 min", SENSORS_LM87_FAN2, 
                        SENSORS_LM87_FAN2, SENSORS_MODE_RW, 
                        LM87_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_LM87_TEMP3, "temp3", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, LM87_SYSCTL_TEMP3, VALUE(3), 1 },
    { SENSORS_LM87_TEMP2, "CPU Temp", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
    ...
    { SENSORS_LM87_TEMP1_HYST, "temp_hyst", SENSORS_LM87_TEMP1,
                         SENSORS_LM87_TEMP1, SENSORS_MODE_RW, 
                         LM87_SYSCTL_TEMP1, VALUE(2), 1 },
    { SENSORS_LM87_TEMP1_OVER, "temp_over", SENSORS_LM87_TEMP1,
                         SENSORS_LM87_TEMP1, SENSORS_MODE_RW, 
                         LM87_SYSCTL_TEMP1, VALUE(1), 1 },
    { SENSORS_LM87_TEMP2_HYST, "temp_hyst", SENSORS_LM87_TEMP2,
                         SENSORS_LM87_TEMP2, SENSORS_MODE_RW, 
                         LM87_SYSCTL_TEMP2, VALUE(2), 1 },
    { SENSORS_LM87_TEMP2_OVER, "temp_over", SENSORS_LM87_TEMP2,
                         SENSORS_LM87_TEMP2, SENSORS_MODE_RW, 
                         LM87_SYSCTL_TEMP2, VALUE(1), 1 },
    { SENSORS_LM87_TEMP3_HYST, "temp_hyst", SENSORS_LM87_TEMP3,
                         SENSORS_LM87_TEMP3, SENSORS_MODE_RW, 
                         LM87_SYSCTL_TEMP3, VALUE(2), 1 },
    { SENSORS_LM87_TEMP3_OVER, "temp_over", SENSORS_LM87_TEMP3,
                         SENSORS_LM87_TEMP3, SENSORS_MODE_RW, 
    ...
    { SENSORS_LM87_FAN1_DIV, "fan_div", SENSORS_LM87_FAN1, 
                         SENSORS_NO_MAPPING, SENSORS_MODE_RW, 
                         LM87_SYSCTL_FAN_DIV, VALUE(1), 0 },
    { SENSORS_LM87_FAN2_DIV, "fan_div", SENSORS_LM87_FAN2, 
                         SENSORS_NO_MAPPING, SENSORS_MODE_RW, 
