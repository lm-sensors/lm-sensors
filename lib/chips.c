...
/* as of -test9, w83781d driver has a mag of 2, not the standard 3;
   the two additional values can be removed after the driver is fixed,
   because getsysname() in proc.c will handle */
...
static sensors_chip_feature via686a_features[] =
  { 
    { SENSORS_VIA686A_IN0, "2.0V", NOMAP, NOMAP, 
                        R, VIA686A_SYSCTL_IN0, VALUE(3), 2, "in_input0", 3 },
    { SENSORS_VIA686A_IN1, "2.5V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN1, VALUE(3), 2, "in_input1", 3 },
    { SENSORS_VIA686A_IN2, "3.3V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN2, VALUE(3), 2, "in_input2", 3 },
    { SENSORS_VIA686A_IN3, "5.0V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN3, VALUE(3), 2, "in_input3", 3 },
    { SENSORS_VIA686A_IN4, "12V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN4, VALUE(3), 2, "in_input4", 3 },
