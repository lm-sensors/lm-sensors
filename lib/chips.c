...
#define SENSORS_ASB100_IN_MIN_MAX(nr) \
	{ SENSORS_ASB100_IN##nr, "in" #nr, SENSORS_NO_MAPPING, \
		SENSORS_NO_MAPPING, SENSORS_MODE_R, ASB100_SYSCTL_IN##nr, \
		VALUE(3), 2 }, \
	{ SENSORS_ASB100_IN##nr##_MIN, "in" #nr "_min", SENSORS_ASB100_IN##nr, \
		SENSORS_ASB100_IN##nr, SENSORS_MODE_RW, ASB100_SYSCTL_IN##nr, \
		VALUE(1), 2 }, \
...
#define SENSORS_ASB100_FAN_MIN_DIV(nr, divmode) \
	{ SENSORS_ASB100_FAN##nr, "fan" #nr, SENSORS_NO_MAPPING, \
		SENSORS_NO_MAPPING, SENSORS_MODE_R, ASB100_SYSCTL_FAN##nr, \
		VALUE(2), 0 }, \
	{ SENSORS_ASB100_FAN##nr##_MIN, "fan" #nr "_min", \
		SENSORS_ASB100_FAN##nr, SENSORS_ASB100_FAN##nr, \
		SENSORS_MODE_RW, ASB100_SYSCTL_FAN##nr, VALUE(1), 0 }, \
	{ SENSORS_ASB100_FAN##nr##_DIV, "fan" #nr "_div", \
		SENSORS_ASB100_FAN##nr,  SENSORS_NO_MAPPING, \
...
#define SENSORS_ASB100_TEMP_OVER_HYST(nr) \
	{ SENSORS_ASB100_TEMP##nr, "temp" #nr, SENSORS_NO_MAPPING, \
		SENSORS_NO_MAPPING, SENSORS_MODE_R, ASB100_SYSCTL_TEMP##nr, \
		VALUE(3), 1 }, \
	{ SENSORS_ASB100_TEMP##nr##_OVER, "temp" #nr "_over", \
		SENSORS_ASB100_TEMP##nr, SENSORS_ASB100_TEMP##nr, \
		SENSORS_MODE_RW, ASB100_SYSCTL_TEMP##nr, VALUE(1), 1 }, \
	{ SENSORS_ASB100_TEMP##nr##_HYST, "temp" #nr "_hyst", \
		SENSORS_ASB100_TEMP##nr, SENSORS_ASB100_TEMP##nr, \
		SENSORS_MODE_RW, ASB100_SYSCTL_TEMP##nr, VALUE(2), 1 }
...
static sensors_chip_feature asb100_features[] = { 
	...
	SENSORS_ASB100_FAN_MIN_DIV(1, SENSORS_MODE_RW),
	SENSORS_ASB100_FAN_MIN_DIV(2, SENSORS_MODE_RW),
	SENSORS_ASB100_FAN_MIN_DIV(3, SENSORS_MODE_RW),
	...
	{ SENSORS_ASB100_VID, "vid", SENSORS_NO_MAPPING,
		SENSORS_NO_MAPPING, SENSORS_MODE_R,
		ASB100_SYSCTL_VID, VALUE(1), 3 },
	{ SENSORS_ASB100_VRM, "vrm", SENSORS_NO_MAPPING,
		SENSORS_NO_MAPPING, SENSORS_MODE_RW,
		ASB100_SYSCTL_VRM, VALUE(1), 1 },
	{ SENSORS_ASB100_ALARMS, "alarms", SENSORS_NO_MAPPING, 
		SENSORS_NO_MAPPING, SENSORS_MODE_R,
	...
	{ SENSORS_ASB100_BEEPS, "beeps", SENSORS_ASB100_ALARMS,
		SENSORS_ASB100_ALARMS, SENSORS_MODE_RW,
...
static sensors_chip_feature fscscy_features[] =
  ...
  {
    { SENSORS_FSCHER_REV, "rev", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_REV, VALUE(1), 0 },
    { SENSORS_FSCHER_EVENT, "alarms", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_EVENT, VALUE(1), 0 },
    { SENSORS_FSCHER_CONTROL, "control", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_RW, FSCHER_SYSCTL_CONTROL, VALUE(1), 0 },
    { SENSORS_FSCHER_VOLTAGE1, "in0", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_VOLT0, VALUE(1), 2 },
    { SENSORS_FSCHER_VOLTAGE2, "in1", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_VOLT1, VALUE(1), 2 },
    { SENSORS_FSCHER_VOLTAGE3, "in2", SENSORS_NO_MAPPING,
			SENSORS_NO_MAPPING, SENSORS_MODE_R, 
			FSCHER_SYSCTL_VOLT2, VALUE(1), 2 },
    { SENSORS_FSCHER_TEMP1, "temp1", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_TEMP0, VALUE(2), 0 },
    { SENSORS_FSCHER_TEMP2, "temp2", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_TEMP1, VALUE(2), 0 },
    { SENSORS_FSCHER_TEMP3, "temp3", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_TEMP2, VALUE(2), 0 },
    { SENSORS_FSCHER_TEMP1_STATE, "temp1_state", SENSORS_FSCHER_TEMP1,
			SENSORS_FSCHER_TEMP1, SENSORS_MODE_RW, 
			FSCHER_SYSCTL_TEMP0, VALUE(1), 0 },
    { SENSORS_FSCHER_TEMP2_STATE, "temp2_state", SENSORS_FSCHER_TEMP2, 
			SENSORS_FSCHER_TEMP2, SENSORS_MODE_RW, 
			FSCHER_SYSCTL_TEMP1, VALUE(1), 0 },
    { SENSORS_FSCHER_TEMP3_STATE, "temp3_state", SENSORS_FSCHER_TEMP3, 
			SENSORS_FSCHER_TEMP3, SENSORS_MODE_RW, 
			FSCHER_SYSCTL_TEMP2, VALUE(1), 0 },
    { SENSORS_FSCHER_FAN1, "fan1", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_FAN0, VALUE(4), 0 },
    { SENSORS_FSCHER_FAN2, "fan2", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_FAN1, VALUE(4), 0 },
    { SENSORS_FSCHER_FAN3, "fan3", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, FSCHER_SYSCTL_FAN2, VALUE(4), 0 },
    { SENSORS_FSCHER_FAN1_MIN, "fan1_min", SENSORS_FSCHER_FAN1, 
			SENSORS_FSCHER_FAN1, SENSORS_MODE_RW, 
			FSCHER_SYSCTL_FAN0, VALUE(2), 0 },
    { SENSORS_FSCHER_FAN2_MIN, "fan2_min", SENSORS_FSCHER_FAN2, 
			SENSORS_FSCHER_FAN2, SENSORS_MODE_RW, 
			FSCHER_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_FSCHER_FAN3_MIN, "fan3_min", SENSORS_FSCHER_FAN3, 
			SENSORS_FSCHER_FAN3, SENSORS_MODE_RW, 
    ...
    { SENSORS_FSCHER_WDOG_PRESET, "wdog_preset", SENSORS_NO_MAPPING, 
			SENSORS_NO_MAPPING, SENSORS_MODE_RW, 
			FSCHER_SYSCTL_WDOG, VALUE(1), 0 },
    { SENSORS_FSCHER_WDOG_STATE, "wdog_state", SENSORS_FSCHER_WDOG_PRESET, 
			SENSORS_FSCHER_WDOG_PRESET, SENSORS_MODE_RW, 
...
static sensors_chip_feature bmc_features[] =
  { 
    { SENSORS_BMC_IN1, "in1", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN, "in1_min", SENSORS_BMC_IN1,
                            SENSORS_BMC_IN1,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX, "in1_max", SENSORS_BMC_IN1,
                            SENSORS_BMC_IN1,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1, VALUE(2), 3 },
    { SENSORS_BMC_IN1+1, "in2", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+1, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+1, "in2_min", SENSORS_BMC_IN1+1,
                            SENSORS_BMC_IN1+1,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+1, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+1, "in2_max", SENSORS_BMC_IN1+1,
                            SENSORS_BMC_IN1+1,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+1, VALUE(2), 3 },
    { SENSORS_BMC_IN1+2, "in3", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+2, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+2, "in3_min", SENSORS_BMC_IN1+2,
                            SENSORS_BMC_IN1+2,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+2, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+2, "in3_max", SENSORS_BMC_IN1+2,
                            SENSORS_BMC_IN1+2,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+2, VALUE(2), 3 },
    { SENSORS_BMC_IN1+3, "in4", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+3, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+3, "in4_min", SENSORS_BMC_IN1+3,
                            SENSORS_BMC_IN1+3,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+3, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+3, "in4_max", SENSORS_BMC_IN1+3,
                            SENSORS_BMC_IN1+3,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+3, VALUE(2), 3 },
    { SENSORS_BMC_IN1+4, "in5", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+4, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+4, "in5_min", SENSORS_BMC_IN1+4,
                            SENSORS_BMC_IN1+4,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+4, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+4, "in5_max", SENSORS_BMC_IN1+4,
                            SENSORS_BMC_IN1+4,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+4, VALUE(2), 3 },
    { SENSORS_BMC_IN1+5, "in6", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+5, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+5, "in6_min", SENSORS_BMC_IN1+5,
                            SENSORS_BMC_IN1+5,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+5, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+5, "in6_max", SENSORS_BMC_IN1+5,
                            SENSORS_BMC_IN1+5,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+5, VALUE(2), 3 },
    { SENSORS_BMC_IN1+6, "in7", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+6, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+6, "in7_min", SENSORS_BMC_IN1+6,
                            SENSORS_BMC_IN1+6,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+6, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+6, "in7_max", SENSORS_BMC_IN1+6,
                            SENSORS_BMC_IN1+6,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+6, VALUE(2), 3 },

    { SENSORS_BMC_IN1+7, "in8", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+7, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+7, "in8_min", SENSORS_BMC_IN1+7,
                            SENSORS_BMC_IN1+7,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+7, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+7, "in8_max", SENSORS_BMC_IN1+7,
                            SENSORS_BMC_IN1+7,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+7, VALUE(2), 3 },
    { SENSORS_BMC_IN1+8, "in9", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+8, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+8, "in9_min", SENSORS_BMC_IN1+8,
                            SENSORS_BMC_IN1+8,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+8, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+8, "in9_max", SENSORS_BMC_IN1+8,
                            SENSORS_BMC_IN1+8,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+8, VALUE(2), 3 },
    { SENSORS_BMC_IN1+9, "in10", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+9, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+9, "in10_min", SENSORS_BMC_IN1+9,
                            SENSORS_BMC_IN1+9,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+9, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+9, "in10_max", SENSORS_BMC_IN1+9,
                            SENSORS_BMC_IN1+9,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+9, VALUE(2), 3 },
    { SENSORS_BMC_IN1+10, "in11", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+10, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+10, "in11_min", SENSORS_BMC_IN1+10,
                            SENSORS_BMC_IN1+10,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+10, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+10, "in11_max", SENSORS_BMC_IN1+10,
                            SENSORS_BMC_IN1+10,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+10, VALUE(2), 3 },
    { SENSORS_BMC_IN1+11, "in12", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+11, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+11, "in12_min", SENSORS_BMC_IN1+11,
                            SENSORS_BMC_IN1+11,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+11, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+11, "in12_max", SENSORS_BMC_IN1+11,
                            SENSORS_BMC_IN1+11,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+11, VALUE(2), 3 },
    { SENSORS_BMC_IN1+12, "in13", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+12, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+12, "in13_min", SENSORS_BMC_IN1+12,
                            SENSORS_BMC_IN1+12,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+12, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+12, "in13_max", SENSORS_BMC_IN1+12,
                            SENSORS_BMC_IN1+12,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+12, VALUE(2), 3 },
    { SENSORS_BMC_IN1+13, "in14", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+13, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+13, "in14_min", SENSORS_BMC_IN1+13,
                            SENSORS_BMC_IN1+13,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+13, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+13, "in14_max", SENSORS_BMC_IN1+13,
                            SENSORS_BMC_IN1+13,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+13, VALUE(2), 3 },
    { SENSORS_BMC_IN1+14, "in15", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+14, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+14, "in15_min", SENSORS_BMC_IN1+14,
                            SENSORS_BMC_IN1+14,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+14, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+14, "in15_max", SENSORS_BMC_IN1+14,
                            SENSORS_BMC_IN1+14,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+14, VALUE(2), 3 },
    { SENSORS_BMC_IN1+15, "in16", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+15, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+15, "in16_min", SENSORS_BMC_IN1+15,
                            SENSORS_BMC_IN1+15,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+15, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+15, "in16_max", SENSORS_BMC_IN1+15,
                            SENSORS_BMC_IN1+15,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+15, VALUE(2), 3 },
    { SENSORS_BMC_IN1+16, "in17", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+16, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+16, "in17_min", SENSORS_BMC_IN1+16,
                            SENSORS_BMC_IN1+16,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+16, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+16, "in17_max", SENSORS_BMC_IN1+16,
                            SENSORS_BMC_IN1+16,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+16, VALUE(2), 3 },
    { SENSORS_BMC_IN1+17, "in18", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+17, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+17, "in18_min", SENSORS_BMC_IN1+17,
                            SENSORS_BMC_IN1+17,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+17, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+17, "in18_max", SENSORS_BMC_IN1+17,
                            SENSORS_BMC_IN1+17,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+17, VALUE(2), 3 },
    { SENSORS_BMC_IN1+18, "in19", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+18, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+18, "in19_min", SENSORS_BMC_IN1+18,
                            SENSORS_BMC_IN1+18,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+18, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+18, "in19_max", SENSORS_BMC_IN1+18,
                            SENSORS_BMC_IN1+18,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+18, VALUE(2), 3 },
    { SENSORS_BMC_IN1+19, "in20", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, BMC_SYSCTL_IN1+19, VALUE(3), 3 },
    { SENSORS_BMC_IN1_MIN+19, "in20_min", SENSORS_BMC_IN1+19,
                            SENSORS_BMC_IN1+19,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+19, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+19, "in20_max", SENSORS_BMC_IN1+19,
                            SENSORS_BMC_IN1+19,
                            SENSORS_MODE_RW, BMC_SYSCTL_IN1+19, VALUE(2), 3 },
    ...
    { SENSORS_BMC_FAN1+7, "fan8", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_FAN1+7, VALUE(2), 0 },
    { SENSORS_BMC_FAN1+8, "fan9", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_FAN1+8, VALUE(2), 0 },
    { SENSORS_BMC_FAN1+9, "fan10", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_FAN1+9, VALUE(2), 0 },
    ...
    { SENSORS_BMC_FAN1_MIN+7, "fan8_min", SENSORS_BMC_FAN1+7,
                             SENSORS_BMC_FAN1+7,
                             SENSORS_MODE_RW, BMC_SYSCTL_FAN1+7, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+8, "fan9_min", SENSORS_BMC_FAN1+8,
                             SENSORS_BMC_FAN1+8,
                             SENSORS_MODE_RW, BMC_SYSCTL_FAN1+8, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+9, "fan10_min", SENSORS_BMC_FAN1+9,
                             SENSORS_BMC_FAN1+9,
                             SENSORS_MODE_RW, BMC_SYSCTL_FAN1+9, VALUE(1), 0 },
    { SENSORS_BMC_TEMP1, "temp1", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1, VALUE(3), 2 },
    ...
    { SENSORS_BMC_TEMP1+1, "temp2", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+1, VALUE(3), 2 },
    ...
    { SENSORS_BMC_TEMP1+2, "temp3", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+2, VALUE(3), 2 },
    ...
    { SENSORS_BMC_TEMP1+3, "temp4", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+3, VALUE(3), 2 },
    ...
    { SENSORS_BMC_TEMP1+4, "temp5", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+4, VALUE(3), 2 },
    ...
    { SENSORS_BMC_TEMP1+5, "temp6", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+5, VALUE(3), 2 },
    ...
    { SENSORS_BMC_TEMP1+6, "temp7", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+6, VALUE(3), 2 },
    ...
    { SENSORS_BMC_TEMP1+7, "temp8", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+7, VALUE(3), 2 },
    { SENSORS_BMC_TEMP1_MIN+7, "temp8_min", SENSORS_BMC_TEMP1+7,
                              SENSORS_BMC_TEMP1+7, SENSORS_MODE_RW, 
                              BMC_SYSCTL_TEMP1+7, VALUE(2), 2 },
    { SENSORS_BMC_TEMP1_MAX+7, "temp8_max", SENSORS_BMC_TEMP1+7,
                              SENSORS_BMC_TEMP1+7, SENSORS_MODE_RW, 
                              BMC_SYSCTL_TEMP1+7, VALUE(1), 2 },
    { SENSORS_BMC_TEMP1+8, "temp9", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+8, VALUE(3), 2 },
    { SENSORS_BMC_TEMP1_MIN+8, "temp9_min", SENSORS_BMC_TEMP1+8,
                              SENSORS_BMC_TEMP1+8, SENSORS_MODE_RW, 
                              BMC_SYSCTL_TEMP1+8, VALUE(2), 2 },
    { SENSORS_BMC_TEMP1_MAX+8, "temp9_max", SENSORS_BMC_TEMP1+8,
                              SENSORS_BMC_TEMP1+8, SENSORS_MODE_RW, 
                              BMC_SYSCTL_TEMP1+8, VALUE(1), 2 },
    { SENSORS_BMC_TEMP1+9, "temp10", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, BMC_SYSCTL_TEMP1+9, VALUE(3), 2 },
    { SENSORS_BMC_TEMP1_MIN+9, "temp10_min", SENSORS_BMC_TEMP1+9,
                              SENSORS_BMC_TEMP1+9, SENSORS_MODE_RW, 
