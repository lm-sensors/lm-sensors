...
static sensors_chip_feature lm87_features[] =
  { 
    { SENSORS_LM87_IN0, "2.5V", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, LM87_SYSCTL_IN0, VALUE(2), 2 },
    ...
    { SENSORS_LM87_FAN2_AIN2, "fan", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                        SENSORS_MODE_R, LM87_SYSCTL_FAN, VALUE(2), 0 },
    { SENSORS_LM87_FAN1_AIN1_LIMIT, "fan1/ain1_limit", SENSORS_LM87_FAN1_AIN1,
                        SENSORS_LM87_FAN1_AIN1, SENSORS_MODE_RW, 
                        LM87_SYSCTL_FAN, VALUE(1), 0 },
    { SENSORS_LM87_FAN2_AIN2_LIMIT, "fan2/ain2_limit", SENSORS_LM87_FAN2_AIN2, 
                        SENSORS_LM87_FAN2_AIN2, SENSORS_MODE_RW, 
                        LM87_SYSCTL_FAN, VALUE(1), 0 },
    { SENSORS_LM87_FRONT_TEMP, "frnt_amb_temp", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, LM87_SYSCTL_FRNT_TEMP, VALUE(3), 1 },
    { SENSORS_LM87_CPU_TEMP, "CPU_Temp", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING, 
                        SENSORS_MODE_R, LM87_SYSCTL_CPU_TEMP, VALUE(3), 1 },
    { SENSORS_LM87_INT_TEMP, "int_temp", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, LM87_SYSCTL_INT_TEMP, VALUE(3), 1 },
    { SENSORS_LM87_INT_TEMP_HYST, "temp_hyst", SENSORS_LM87_INT_TEMP,
                         SENSORS_LM87_INT_TEMP, SENSORS_MODE_RW, 
                         LM87_SYSCTL_INT_TEMP, VALUE(2), 1 },
    { SENSORS_LM87_INT_TEMP_OVER, "temp_over", SENSORS_LM87_INT_TEMP,
                         SENSORS_LM87_INT_TEMP, SENSORS_MODE_RW, 
                         LM87_SYSCTL_INT_TEMP, VALUE(1), 1 },
    { SENSORS_LM87_VID, "vid", SENSORS_NO_MAPPING, SENSORS_NO_MAPPING,
                         SENSORS_MODE_R, LM87_SYSCTL_VID, VALUE(1), 2 },
    { SENSORS_LM87_FAN_DIV, "fan_div", SENSORS_LM87_FAN2_AIN2, 
                         SENSORS_NO_MAPPING, SENSORS_MODE_RW, 
