...
static sensors_chip_feature as99127f_features[] =
  { 
    { SENSORS_W83782D_IN0, "in0", NOMAP, NOMAP, 
                        R, W83781D_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_W83782D_IN1, "in1", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_W83782D_IN2, "in2", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_W83782D_IN3, "in3", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_W83782D_IN4, "in4", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_W83782D_IN5, "in5", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN5, VALUE(3), 2 },
    { SENSORS_W83782D_IN6, "in6", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN6, VALUE(3), 2 },
...
/* swap 5 and 6 min/max because compute lines will be inverting */
    ...
    { SENSORS_W83782D_IN6_MAX, "in6_max", SENSORS_W83782D_IN6, 
                        SENSORS_W83782D_IN6, RW, 
                        W83781D_SYSCTL_IN6, VALUE(1), 2, "in6_min", 3 },
    { SENSORS_W83782D_FAN1, "fan1", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_W83782D_FAN2, "fan2", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_W83781D_FAN3, "fan3", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN3, VALUE(2), 0 },
    ...
    { SENSORS_W83781D_FAN3_MIN, "fan3_min", SENSORS_W83781D_FAN3, 
                        ...
                        W83781D_SYSCTL_FAN3, VALUE(1), 0 },
    { SENSORS_W83782D_TEMP1, "temp1", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_TEMP1, VALUE(3), 1 },
    ...
    { SENSORS_W83782D_TEMP1_OVER, "temp1_over", SENSORS_W83782D_TEMP1,
                         SENSORS_W83782D_TEMP1, RW, 
                         W83781D_SYSCTL_TEMP1, VALUE(1), 1 },
    { SENSORS_W83782D_TEMP2, "temp2", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_TEMP2, VALUE(3), 1 },
    ...
    { SENSORS_W83782D_TEMP2_OVER, "temp2_over", SENSORS_W83782D_TEMP2,
                         SENSORS_W83782D_TEMP2, RW, 
                         W83781D_SYSCTL_TEMP2, VALUE(1), 1 },
    { SENSORS_W83782D_TEMP3, "temp3", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_TEMP3, VALUE(3), 1 },
    ...
    { SENSORS_W83782D_FAN3_DIV, "fan3_div", SENSORS_W83781D_FAN3, 
                         NOMAP, RW, 
                         W83781D_SYSCTL_FAN_DIV, VALUE(3), 0 },
    { SENSORS_W83782D_ALARMS, "alarms", NOMAP, NOMAP, 
                         R, W83781D_SYSCTL_ALARMS, VALUE(1), 0 },
...
static sensors_chip_feature lm93_features[] = {
	...
	SENSORS_LM93_VID(1),
	SENSORS_LM93_VID(2),
	{ SENSORS_LM93_ALARMS, "alarms", NOMAP, 
		NOMAP, R,
...
#define SENSORS_ASB100_IN_MIN_MAX(nr) \
	{ SENSORS_ASB100_IN##nr, "in" #nr, NOMAP, \
		NOMAP, R, ASB100_SYSCTL_IN##nr, \
		VALUE(3), 2 }, \
	{ SENSORS_ASB100_IN##nr##_MIN, "in" #nr "_min", SENSORS_ASB100_IN##nr, \
		SENSORS_ASB100_IN##nr, RW, ASB100_SYSCTL_IN##nr, \
		VALUE(1), 2 }, \
...
#define SENSORS_ASB100_FAN_MIN_DIV(nr, divmode) \
	{ SENSORS_ASB100_FAN##nr, "fan" #nr, NOMAP, \
		NOMAP, R, ASB100_SYSCTL_FAN##nr, \
		VALUE(2), 0 }, \
	{ SENSORS_ASB100_FAN##nr##_MIN, "fan" #nr "_min", \
		SENSORS_ASB100_FAN##nr, SENSORS_ASB100_FAN##nr, \
		RW, ASB100_SYSCTL_FAN##nr, VALUE(1), 0 }, \
	{ SENSORS_ASB100_FAN##nr##_DIV, "fan" #nr "_div", \
		SENSORS_ASB100_FAN##nr,  NOMAP, \
		divmode, ASB100_SYSCTL_FAN_DIV, VALUE(nr), 0 }
...
#define SENSORS_ASB100_TEMP_OVER_HYST(nr) \
	{ SENSORS_ASB100_TEMP##nr, "temp" #nr, NOMAP, \
		NOMAP, R, ASB100_SYSCTL_TEMP##nr, \
		VALUE(3), 1 }, \
	{ SENSORS_ASB100_TEMP##nr##_OVER, "temp" #nr "_over", \
		SENSORS_ASB100_TEMP##nr, SENSORS_ASB100_TEMP##nr, \
		RW, ASB100_SYSCTL_TEMP##nr, VALUE(1), 1 }, \
	{ SENSORS_ASB100_TEMP##nr##_HYST, "temp" #nr "_hyst", \
		SENSORS_ASB100_TEMP##nr, SENSORS_ASB100_TEMP##nr, \
		RW, ASB100_SYSCTL_TEMP##nr, VALUE(2), 1 }
...
static sensors_chip_feature asb100_features[] = { 
	...
	{ SENSORS_ASB100_VID, "vid", NOMAP,
		NOMAP, R,
		ASB100_SYSCTL_VID, VALUE(1), 3 },
	{ SENSORS_ASB100_VRM, "vrm", NOMAP,
		NOMAP, RW,
		ASB100_SYSCTL_VRM, VALUE(1), 1 },
	{ SENSORS_ASB100_ALARMS, "alarms", NOMAP, 
		NOMAP, R,
...
static sensors_chip_feature w83782d_features[] =
  { 
    ...
    { SENSORS_W83782D_IN6, "in6", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN6, VALUE(3), 2 },
    { SENSORS_W83782D_IN7, "in7", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN7, VALUE(3), 2 },
    { SENSORS_W83782D_IN8, "in8", NOMAP, NOMAP,
    ...
    { SENSORS_W83782D_BEEPS, "beeps", SENSORS_W83782D_ALARMS,
                         SENSORS_W83782D_ALARMS, RW,
                         W83781D_SYSCTL_BEEP, VALUE(2), 0 },
    { SENSORS_W83782D_SENS1, "sensor1", NOMAP, NOMAP,
                         RW, W83781D_SYSCTL_SENS1, VALUE(1), 0 },
    { SENSORS_W83782D_SENS2, "sensor2", NOMAP, NOMAP,
                         RW, W83781D_SYSCTL_SENS2, VALUE(1), 0 },
    { SENSORS_W83782D_SENS3, "sensor3", NOMAP, NOMAP,
...
static sensors_chip_feature w83783s_features[] =
  { 
    { SENSORS_W83783S_IN0, "in0", NOMAP, NOMAP, 
                        R, W83781D_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_W83783S_IN1, "in1", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_W83783S_IN2, "in2", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_W83783S_IN3, "in3", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_W83783S_IN4, "in4", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_W83783S_IN5, "in5", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN5, VALUE(3), 2 },
    { SENSORS_W83783S_IN6, "in6", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN6, VALUE(3), 2 },
    ...
    { SENSORS_W83783S_IN6_MAX, "in6_max", SENSORS_W83783S_IN6, 
                        SENSORS_W83783S_IN6, RW, 
                        W83781D_SYSCTL_IN6, VALUE(2), 2 },
    { SENSORS_W83783S_FAN1, "fan1", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_W83783S_FAN2, "fan2", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_W83783S_FAN3, "fan3", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN3, VALUE(2), 0 },
    ...
    { SENSORS_W83782D_TEMP2_OVER, "temp2_over", SENSORS_W83782D_TEMP2,
                         SENSORS_W83782D_TEMP2, RW, 
                         W83781D_SYSCTL_TEMP2, VALUE(1), 1 },
    { SENSORS_W83783S_VID, "vid", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_VID, VALUE(1), 3 },
    { SENSORS_W83783S_VRM, "vrm", NOMAP, NOMAP,
                         RW, W83781D_SYSCTL_VRM, VALUE(1), 1 },
    ...
    { SENSORS_W83783S_FAN3_DIV, "fan3_div", SENSORS_W83783S_FAN3, 
                         NOMAP, RW, 
                         W83781D_SYSCTL_FAN_DIV, VALUE(3), 0 },
    { SENSORS_W83783S_ALARMS, "alarms", NOMAP, NOMAP, 
                         R, W83781D_SYSCTL_ALARMS, VALUE(1), 0 },
    ...
    { SENSORS_W83783S_BEEPS, "beeps", SENSORS_W83783S_ALARMS,
                         ...
                         W83781D_SYSCTL_BEEP, VALUE(2), 0 },
    { SENSORS_W83783S_SENS1, "sensor1", NOMAP, NOMAP,
                         RW, W83781D_SYSCTL_SENS1, VALUE(1), 0 },
    { SENSORS_W83783S_SENS2, "sensor2", NOMAP, NOMAP,
                         RW, W83781D_SYSCTL_SENS2, VALUE(1), 0 },
    { 0 }
  };
...
static sensors_chip_feature w83791d_features[] =
  { 
    { SENSORS_W83791D_IN0, "in0", NOMAP, NOMAP, 
                        R, W83781D_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_W83791D_IN1, "in1", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_W83791D_IN2, "in2", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_W83791D_IN3, "in3", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_W83791D_IN4, "in4", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_W83791D_IN5, "in5", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN5, VALUE(3), 2 },
    { SENSORS_W83791D_IN6, "in6", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN6, VALUE(3), 2 },
    { SENSORS_W83791D_IN7, "in7", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN7, VALUE(3), 2 },
    { SENSORS_W83791D_IN8, "in8", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN8, VALUE(3), 2 },
    { SENSORS_W83791D_IN9, "in9", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_IN9, VALUE(3), 2 },
    ...
    { SENSORS_W83791D_FAN1, "fan1", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_W83791D_FAN2, "fan2", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_W83791D_FAN3, "fan3", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN3, VALUE(2), 0 },
    { SENSORS_W83791D_FAN4, "fan4", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN4, VALUE(2), 0 },
    { SENSORS_W83791D_FAN5, "fan5", NOMAP, NOMAP,
                        R, W83781D_SYSCTL_FAN5, VALUE(2), 0 },
    ...
    { SENSORS_W83791D_TEMP1, "temp1", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_TEMP1, VALUE(3), 1 },
    ...
    { SENSORS_W83791D_TEMP1_OVER, "temp1_over", SENSORS_W83791D_TEMP1,
                         SENSORS_W83791D_TEMP1, RW, 
                         W83781D_SYSCTL_TEMP1, VALUE(1), 1 },
    { SENSORS_W83791D_TEMP2, "temp2", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_TEMP2, VALUE(3), 1 },
    ...
    { SENSORS_W83791D_TEMP2_OVER, "temp2_over", SENSORS_W83791D_TEMP2,
                         SENSORS_W83791D_TEMP2, RW, 
                         W83781D_SYSCTL_TEMP2, VALUE(1), 1 },
    { SENSORS_W83791D_TEMP3, "temp3", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_TEMP3, VALUE(3), 1 },
    ...
    { SENSORS_W83791D_TEMP3_OVER, "temp3_over", SENSORS_W83791D_TEMP3,
                         SENSORS_W83791D_TEMP3, RW, 
                         W83781D_SYSCTL_TEMP3, VALUE(1), 1 },
    { SENSORS_W83791D_VID, "vid", NOMAP, NOMAP,
                         R, W83781D_SYSCTL_VID, VALUE(1), 3 },
    { SENSORS_W83791D_VRM, "vrm", NOMAP, NOMAP,
                         RW, W83781D_SYSCTL_VRM, VALUE(1), 1 },
    ...
    { SENSORS_W83791D_ALARMS, "alarms", NOMAP, NOMAP, 
                         R, W83781D_SYSCTL_ALARMS, VALUE(1), 0 },
...
static sensors_chip_feature adm9240_features[] =
  { 
    { SENSORS_ADM9240_IN0, "2.5V", NOMAP, NOMAP, 
                        R, ADM9240_SYSCTL_IN0, VALUE(3), 2, "in0_input", 3 },
    { SENSORS_ADM9240_IN1, "Vccp1", NOMAP, NOMAP,
                        R, ADM9240_SYSCTL_IN1, VALUE(3), 2, "in1_input", 3 },
    { SENSORS_ADM9240_IN2, "3.3V", NOMAP, NOMAP,
                        R, ADM9240_SYSCTL_IN2, VALUE(3), 2, "in2_input", 3 },
    { SENSORS_ADM9240_IN3, "5V", NOMAP, NOMAP,
                        R, ADM9240_SYSCTL_IN3, VALUE(3), 2, "in3_input", 3 },
    { SENSORS_ADM9240_IN4, "12V", NOMAP, NOMAP,
                        R, ADM9240_SYSCTL_IN4, VALUE(3), 2, "in4_input", 3 },
    { SENSORS_ADM9240_IN5, "Vccp2", NOMAP, NOMAP,
                        R, ADM9240_SYSCTL_IN5, VALUE(3), 2, "in5_input", 3 },
    ...
    { SENSORS_ADM9240_FAN1, "fan1", NOMAP, NOMAP,
                        R, ADM9240_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_ADM9240_FAN2, "fan2", NOMAP, NOMAP,
    ...
    { SENSORS_ADM9240_TEMP, "temp", NOMAP, NOMAP,
                         R, ADM9240_SYSCTL_TEMP, VALUE(3), 1, "temp1_input", 3 },
    { SENSORS_ADM9240_TEMP_HYST, "temp_hyst", SENSORS_ADM9240_TEMP,
                         SENSORS_ADM9240_TEMP, RW, 
                         ADM9240_SYSCTL_TEMP, VALUE(2), 1, "temp1_max_hyst", 3 },
    ...
    { SENSORS_ADM9240_ALARMS, "alarms", NOMAP, NOMAP, 
...
static sensors_chip_feature adm1024_features[] =
  { 
    { SENSORS_ADM1024_IN0, "2.5V", NOMAP, NOMAP, 
                        R, ADM1024_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_ADM1024_IN1, "Vccp1", NOMAP, NOMAP,
                        R, ADM1024_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_ADM1024_IN2, "3.3V", NOMAP, NOMAP,
                        R, ADM1024_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_ADM1024_IN3, "5V", NOMAP, NOMAP,
                        R, ADM1024_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_ADM1024_IN4, "12V", NOMAP, NOMAP,
                        R, ADM1024_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_ADM1024_IN5, "Vccp2", NOMAP, NOMAP,
                        R, ADM1024_SYSCTL_IN5, VALUE(3), 2 },
    ...
    { SENSORS_ADM1024_FAN1, "fan1", NOMAP, NOMAP,
                        R, ADM1024_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_ADM1024_FAN2, "fan2", NOMAP, NOMAP,
                        R, ADM1024_SYSCTL_FAN2, VALUE(2), 0 },
    ...
    { SENSORS_ADM1024_TEMP, "temp", NOMAP, NOMAP,
                         R, ADM1024_SYSCTL_TEMP, VALUE(3), 1 },
    { SENSORS_ADM1024_TEMP1, "temp1", NOMAP, NOMAP,
                         R, ADM1024_SYSCTL_TEMP1, VALUE(3), 1 },
    { SENSORS_ADM1024_TEMP2, "temp2", NOMAP, NOMAP,
                         R, ADM1024_SYSCTL_TEMP2, VALUE(3), 1 },
    ...
    { SENSORS_ADM1024_VID, "vid", NOMAP, NOMAP,
                         R, ADM1024_SYSCTL_VID, VALUE(1), 2 },
    ...
    { SENSORS_ADM1024_ALARMS, "alarms", NOMAP, NOMAP, 
                         R, ADM1024_SYSCTL_ALARMS, VALUE(1), 0 },
    { SENSORS_ADM1024_ANALOG_OUT, "analog_out", NOMAP,
                         NOMAP, RW,
...
static sensors_chip_feature sis5595_features[] =
  { 
    { SENSORS_SIS5595_IN0, "in0", NOMAP, NOMAP, 
                        R, LM78_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_SIS5595_IN1, "in1", NOMAP, NOMAP,
                        R, LM78_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_SIS5595_IN2, "in2", NOMAP, NOMAP,
                        R, LM78_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_SIS5595_IN3, "in3", NOMAP, NOMAP,
                        R, LM78_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_SIS5595_IN4, "in4", NOMAP, NOMAP,
                        R, LM78_SYSCTL_IN4, VALUE(3), 2 },
    ...
    { SENSORS_SIS5595_IN4_MAX, "in4_max", SENSORS_SIS5595_IN4, SENSORS_SIS5595_IN4,
                            RW, LM78_SYSCTL_IN4, VALUE(2), 2 },
    { SENSORS_SIS5595_FAN1, "fan1", NOMAP, NOMAP,
                         R, LM78_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_SIS5595_FAN2, "fan2", NOMAP, NOMAP,
                         R, LM78_SYSCTL_FAN2, VALUE(2), 0 },
    ...
    { SENSORS_SIS5595_FAN2_MIN, "fan2_min", SENSORS_SIS5595_FAN2, SENSORS_SIS5595_FAN2,
                             RW, LM78_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_SIS5595_TEMP, "temp", NOMAP, NOMAP,
                         R, LM78_SYSCTL_TEMP, VALUE(3), 1 },
    ...
    { SENSORS_SIS5595_TEMP_OVER, "temp_over", SENSORS_SIS5595_TEMP,
                              SENSORS_SIS5595_TEMP, RW, 
                              LM78_SYSCTL_TEMP, VALUE(1), 1 },
    { SENSORS_SIS5595_FAN1_DIV, "fan1_div", SENSORS_SIS5595_FAN1, NOMAP,
                             RW, LM78_SYSCTL_FAN_DIV, VALUE(1), 
                             0 },
    { SENSORS_SIS5595_FAN2_DIV, "fan2_div", SENSORS_SIS5595_FAN2, NOMAP,
                             RW, LM78_SYSCTL_FAN_DIV, VALUE(2), 
                             0 },
    { SENSORS_SIS5595_ALARMS, "alarms", NOMAP, NOMAP, 
                           R, LM78_SYSCTL_ALARMS, VALUE(1), 0 },
    { 0 }
  };
...
static sensors_chip_feature maxi_cg_features[] =
  { 
    { SENSORS_MAXI_CG_FAN1, "fan1", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN1, VALUE(3), 0 },
    { SENSORS_MAXI_CG_FAN2, "fan2", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN2, VALUE(3), 0 },
    { SENSORS_MAXI_CG_FAN3, "fan3", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN3, VALUE(3), 0 },
    { SENSORS_MAXI_CG_FAN1_MIN, "fan1_min", SENSORS_MAXI_CG_FAN1, SENSORS_MAXI_CG_FAN1,
                             RW, MAXI_SYSCTL_FAN1, VALUE(1), 0 },
    { SENSORS_MAXI_CG_FAN2_MIN, "fan2_min", SENSORS_MAXI_CG_FAN2, SENSORS_MAXI_CG_FAN2,
                             RW, MAXI_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_MAXI_CG_FAN3_MIN, "fan3_min", SENSORS_MAXI_CG_FAN3, SENSORS_MAXI_CG_FAN3,
                             RW, MAXI_SYSCTL_FAN3, VALUE(1), 0 },
    { SENSORS_MAXI_CG_FAN1_DIV, "fan1_div", SENSORS_MAXI_CG_FAN1, NOMAP,
                             R, MAXI_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_MAXI_CG_FAN2_DIV, "fan2_div", SENSORS_MAXI_CG_FAN2, NOMAP,
                             R, MAXI_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_MAXI_CG_FAN3_DIV, "fan3_div", SENSORS_MAXI_CG_FAN3, NOMAP,
                             R, MAXI_SYSCTL_FAN3, VALUE(2), 0 },
    { SENSORS_MAXI_CG_TEMP1, "temp1", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP1, VALUE(3), 1 },
    { SENSORS_MAXI_CG_TEMP2, "temp2", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP2, VALUE(3), 1 },
    { SENSORS_MAXI_CG_TEMP3, "temp3", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP3, VALUE(3), 1 },
    { SENSORS_MAXI_CG_TEMP4, "temp4", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP4, VALUE(3), 1 },
    { SENSORS_MAXI_CG_TEMP5, "temp5", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP5, VALUE(3), 1 },
    ...
    { SENSORS_MAXI_CG_PLL, "pll", NOMAP, NOMAP,
                        R, MAXI_SYSCTL_PLL, VALUE(3), 2 },
    { SENSORS_MAXI_CG_PLL_MIN, "pll_min", SENSORS_MAXI_CG_PLL, SENSORS_MAXI_CG_PLL,
                            RW, MAXI_SYSCTL_PLL, VALUE(1), 2 },
    { SENSORS_MAXI_CG_PLL_MAX, "pll_max", SENSORS_MAXI_CG_PLL, SENSORS_MAXI_CG_PLL,
                            RW, MAXI_SYSCTL_PLL, VALUE(2), 2 },
    { SENSORS_MAXI_CG_VID1, "vid1", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID1, VALUE(3), 4 },
    { SENSORS_MAXI_CG_VID2, "vid2", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID2, VALUE(3), 4 },
    { SENSORS_MAXI_CG_VID3, "vid3", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID3, VALUE(3), 4 },
    { SENSORS_MAXI_CG_VID4, "vid4", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID4, VALUE(3), 4 },
    { SENSORS_MAXI_CG_VID1_MIN, "vid1_min", SENSORS_MAXI_CG_VID1, SENSORS_MAXI_CG_VID1,
                             RW, MAXI_SYSCTL_VID1, VALUE(1), 4 },
    { SENSORS_MAXI_CG_VID2_MIN, "vid2_min", SENSORS_MAXI_CG_VID2, SENSORS_MAXI_CG_VID2,
                             RW, MAXI_SYSCTL_VID2, VALUE(1), 4 },
    { SENSORS_MAXI_CG_VID3_MIN, "vid3_min", SENSORS_MAXI_CG_VID3, SENSORS_MAXI_CG_VID3,
                             RW, MAXI_SYSCTL_VID3, VALUE(1), 4 },
    { SENSORS_MAXI_CG_VID4_MIN, "vid4_min", SENSORS_MAXI_CG_VID4, SENSORS_MAXI_CG_VID4,
                             RW, MAXI_SYSCTL_VID4, VALUE(1), 4 },
    { SENSORS_MAXI_CG_VID1_MAX, "vid1_max", SENSORS_MAXI_CG_VID1, SENSORS_MAXI_CG_VID1,
                             RW, MAXI_SYSCTL_VID1, VALUE(2), 4 },
    { SENSORS_MAXI_CG_VID2_MAX, "vid2_max", SENSORS_MAXI_CG_VID2, SENSORS_MAXI_CG_VID2,
                             RW, MAXI_SYSCTL_VID2, VALUE(2), 4 },
    { SENSORS_MAXI_CG_VID3_MAX, "vid3_max", SENSORS_MAXI_CG_VID3, SENSORS_MAXI_CG_VID3,
                             RW, MAXI_SYSCTL_VID3, VALUE(2), 4 },
    { SENSORS_MAXI_CG_VID4_MAX, "vid4_max", SENSORS_MAXI_CG_VID4, SENSORS_MAXI_CG_VID4,
                             RW, MAXI_SYSCTL_VID4, VALUE(2), 4 },
    { SENSORS_MAXI_CG_ALARMS, "alarms", NOMAP, NOMAP, 
                           R, MAXI_SYSCTL_ALARMS, VALUE(1), 0 },
    { 0 }
  };

static sensors_chip_feature maxi_co_features[] =
  { 
    { SENSORS_MAXI_CO_FAN1, "fan1", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN1, VALUE(3), 0 },
    { SENSORS_MAXI_CO_FAN2, "fan2", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN2, VALUE(3), 0 },
    { SENSORS_MAXI_CO_FAN3, "fan3", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN3, VALUE(3), 0 },
    ...
    { SENSORS_MAXI_CO_FAN3_MIN, "fan3_min", SENSORS_MAXI_CO_FAN3, SENSORS_MAXI_CO_FAN3,
                             RW, MAXI_SYSCTL_FAN3, VALUE(1), 0 },
    { SENSORS_MAXI_CO_FAN1_DIV, "fan1_div", SENSORS_MAXI_CO_FAN1, NOMAP,
                             R, MAXI_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_MAXI_CO_FAN2_DIV, "fan2_div", SENSORS_MAXI_CO_FAN2, NOMAP,
                             R, MAXI_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_MAXI_CO_FAN3_DIV, "fan3_div", SENSORS_MAXI_CO_FAN3, NOMAP,
                             R, MAXI_SYSCTL_FAN3, VALUE(2), 0 },
    { SENSORS_MAXI_CO_TEMP1, "temp1", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP1, VALUE(3), 1 },
    { SENSORS_MAXI_CO_TEMP2, "temp2", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP2, VALUE(3), 1 },
    { SENSORS_MAXI_CO_TEMP3, "temp3", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP3, VALUE(3), 1 },
    { SENSORS_MAXI_CO_TEMP4, "temp4", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP4, VALUE(3), 1 },
    { SENSORS_MAXI_CO_TEMP5, "temp5", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP5, VALUE(3), 1 },
    ...
    { SENSORS_MAXI_CO_TEMP5_HYST, "temp5_hyst", SENSORS_MAXI_CO_TEMP5,
                              SENSORS_MAXI_CO_TEMP5, R, 
                              MAXI_SYSCTL_TEMP5, VALUE(2), 1 },
    { SENSORS_MAXI_CO_PLL, "pll", NOMAP, NOMAP,
                        R, MAXI_SYSCTL_PLL, VALUE(3), 2 },
    ...
    { SENSORS_MAXI_CO_PLL_MAX, "pll_max", SENSORS_MAXI_CO_PLL, SENSORS_MAXI_CO_PLL,
                            RW, MAXI_SYSCTL_PLL, VALUE(2), 2 },
    { SENSORS_MAXI_CO_VID1, "vid1", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID1, VALUE(3), 4 },
    { SENSORS_MAXI_CO_VID2, "vid2", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID2, VALUE(3), 4 },
    { SENSORS_MAXI_CO_VID3, "vid3", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID3, VALUE(3), 4 },
    { SENSORS_MAXI_CO_VID4, "vid4", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID4, VALUE(3), 4 },
    ...
    { SENSORS_MAXI_CO_VID4_MAX, "vid4_max", SENSORS_MAXI_CO_VID4, SENSORS_MAXI_CG_VID4,
                             RW, MAXI_SYSCTL_VID4, VALUE(2), 4 },
    { SENSORS_MAXI_CO_ALARMS, "alarms", NOMAP, NOMAP, 
                           R, MAXI_SYSCTL_ALARMS, VALUE(1), 0 },
    { 0 }
  };
...
static sensors_chip_feature maxi_as_features[] =
  { 
    { SENSORS_MAXI_AS_FAN1, "fan1", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN1, VALUE(3), 0 },
    { SENSORS_MAXI_AS_FAN2, "fan2", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN2, VALUE(3), 0 },
    { SENSORS_MAXI_AS_FAN3, "fan3", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_FAN3, VALUE(3), 0 },
    ...
    { SENSORS_MAXI_AS_FAN3_MIN, "fan3_min", SENSORS_MAXI_AS_FAN3, SENSORS_MAXI_AS_FAN3,
                             RW, MAXI_SYSCTL_FAN3, VALUE(1), 0 },
    { SENSORS_MAXI_AS_FAN1_DIV, "fan1_div", SENSORS_MAXI_AS_FAN1, NOMAP,
                             R, MAXI_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_MAXI_AS_FAN2_DIV, "fan2_div", SENSORS_MAXI_AS_FAN2, NOMAP,
                             R, MAXI_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_MAXI_AS_FAN3_DIV, "fan3_div", SENSORS_MAXI_AS_FAN3, NOMAP,
                             R, MAXI_SYSCTL_FAN3, VALUE(2), 0 },
    { SENSORS_MAXI_AS_TEMP1, "temp1", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP1, VALUE(3), 1 },
    { SENSORS_MAXI_AS_TEMP2, "temp2", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP2, VALUE(3), 1 },
    { SENSORS_MAXI_AS_TEMP3, "temp3", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP3, VALUE(3), 1 },
    { SENSORS_MAXI_AS_TEMP4, "temp4", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP4, VALUE(3), 1 },
    { SENSORS_MAXI_AS_TEMP5, "temp5", NOMAP, NOMAP,
                          R, MAXI_SYSCTL_TEMP5, VALUE(3), 1 },
    ...
    { SENSORS_MAXI_AS_TEMP5_HYST, "temp5_hyst", SENSORS_MAXI_AS_TEMP5,
                              SENSORS_MAXI_AS_TEMP5, R, 
                              MAXI_SYSCTL_TEMP5, VALUE(2), 1 },
    { SENSORS_MAXI_AS_PLL, "pll", NOMAP, NOMAP,
                        R, MAXI_SYSCTL_PLL, VALUE(3), 2 },
    ...
    { SENSORS_MAXI_AS_PLL_MAX, "pll_max", SENSORS_MAXI_AS_PLL, SENSORS_MAXI_AS_PLL,
                            RW, MAXI_SYSCTL_PLL, VALUE(2), 2 },
    { SENSORS_MAXI_AS_VID1, "vid1", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID1, VALUE(3), 4 },
    { SENSORS_MAXI_AS_VID2, "vid2", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID2, VALUE(3), 4 },
    { SENSORS_MAXI_AS_VID3, "vid3", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID3, VALUE(3), 4 },
    { SENSORS_MAXI_AS_VID4, "vid4", NOMAP, NOMAP,
                         R, MAXI_SYSCTL_VID4, VALUE(3), 4 },
    ...
    { SENSORS_MAXI_AS_VID4_MAX, "vid4_max", SENSORS_MAXI_AS_VID4, SENSORS_MAXI_CG_VID4,
                             RW, MAXI_SYSCTL_VID4, VALUE(2), 4 },
    { SENSORS_MAXI_AS_ALARMS, "alarms", NOMAP, NOMAP, 
                           R, MAXI_SYSCTL_ALARMS, VALUE(1), 0 },
    { 0 }
  };
...
static sensors_chip_feature thmc50_features[] =
  {
    { SENSORS_THMC50_TEMP, "temp", NOMAP, NOMAP,
                              R, THMC50_SYSCTL_TEMP, VALUE(3), 
                              0 },
    ...
    { SENSORS_THMC50_REMOTE_TEMP, "remote_temp", NOMAP, 
                              NOMAP, R, 
    ...
    { SENSORS_THMC50_INTER_MASK, "analog output", NOMAP,
                              NOMAP, RW,
                              THMC50_SYSCTL_ANALOG_OUT, VALUE(1), 0 },
    { SENSORS_THMC50_INTER, "interrupts", NOMAP,
                              NOMAP, R,
                              THMC50_SYSCTL_INTER, VALUE(1), 0 },
    { SENSORS_THMC50_INTER_MASK, "interrupt mask", NOMAP,
                              NOMAP, RW,
                              THMC50_SYSCTL_INTER_MASK, VALUE(1), 0 },
    { SENSORS_THMC50_DIE_CODE, "die_code", NOMAP,
                              NOMAP, R,
...
static sensors_chip_feature adm1025_features[] =
  { 
    { SENSORS_ADM1025_IN0, "in0", NOMAP, NOMAP, 
                        R, ADM1025_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_ADM1025_IN1, "in1", NOMAP, NOMAP,
                        R, ADM1025_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_ADM1025_IN2, "in2", NOMAP, NOMAP,
                        R, ADM1025_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_ADM1025_IN3, "in3", NOMAP, NOMAP,
                        R, ADM1025_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_ADM1025_IN4, "in4", NOMAP, NOMAP,
                        R, ADM1025_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_ADM1025_IN5, "in5", NOMAP, NOMAP,
                        R, ADM1025_SYSCTL_IN5, VALUE(3), 2 },
    ...
    { SENSORS_ADM1025_TEMP1, "temp1", NOMAP, NOMAP,
                         R, ADM1025_SYSCTL_RTEMP, VALUE(3), 1 },
    ...
    { SENSORS_ADM1025_TEMP2, "temp2", NOMAP, NOMAP,
                         R, ADM1025_SYSCTL_TEMP, VALUE(3), 1 },
    ...
    { SENSORS_ADM1025_ALARMS, "alarms", NOMAP, NOMAP, 
                         R, ADM1025_SYSCTL_ALARMS, VALUE(1), 0 },
    { 0 }
  };
...
static sensors_chip_feature adm1026_features[] = {
    ...
    { SENSORS_ADM1026_ALARM_MASK, "alarm_mask",
		SENSORS_ADM1026_ALARMS, NOMAP, R,
    ...
    { SENSORS_ADM1026_IN0_MIN, "in0_min",
		SENSORS_ADM1026_IN0, SENSORS_ADM1026_IN0, RW,
    ...
    { SENSORS_ADM1026_IN1_MIN, "in1_min",
		SENSORS_ADM1026_IN1, SENSORS_ADM1026_IN1, RW,
    ...
    { SENSORS_ADM1026_IN2_MIN, "in2_min",
		SENSORS_ADM1026_IN2, SENSORS_ADM1026_IN2, RW,
    ...
    { SENSORS_ADM1026_IN3_MIN, "in3_min",
		SENSORS_ADM1026_IN3, SENSORS_ADM1026_IN3, RW,
    ...
    { SENSORS_ADM1026_IN4_MIN, "in4_min",
		SENSORS_ADM1026_IN4, SENSORS_ADM1026_IN4, RW,
    ...
    { SENSORS_ADM1026_IN5_MIN, "in5_min",
		SENSORS_ADM1026_IN5, SENSORS_ADM1026_IN5, RW,
    ...
    { SENSORS_ADM1026_IN6_MIN, "in6_min",
		SENSORS_ADM1026_IN6, SENSORS_ADM1026_IN6, RW,
    ...
    { SENSORS_ADM1026_IN7_MIN, "in7_min",
		SENSORS_ADM1026_IN7, SENSORS_ADM1026_IN7, RW,
    ...
    { SENSORS_ADM1026_IN8_MIN, "in8_min",
		SENSORS_ADM1026_IN8, SENSORS_ADM1026_IN8, RW,
    ...
    { SENSORS_ADM1026_IN9_MIN, "in9_min",
		SENSORS_ADM1026_IN9, SENSORS_ADM1026_IN9, RW,
    ...
    { SENSORS_ADM1026_IN10_MIN, "in10_min",
		SENSORS_ADM1026_IN10, SENSORS_ADM1026_IN10, RW,
    ...
    { SENSORS_ADM1026_IN11_MIN, "in11_min",
		SENSORS_ADM1026_IN11, SENSORS_ADM1026_IN11, RW,
    ...
    { SENSORS_ADM1026_IN12_MIN, "in12_min",
		SENSORS_ADM1026_IN12, SENSORS_ADM1026_IN12, RW,
    ...
    { SENSORS_ADM1026_IN13_MIN, "in13_min",
		SENSORS_ADM1026_IN13, SENSORS_ADM1026_IN13, RW,
    ...
    { SENSORS_ADM1026_IN14_MIN, "in14_min",
		SENSORS_ADM1026_IN14, SENSORS_ADM1026_IN14, RW,
    ...
    { SENSORS_ADM1026_IN15_MIN, "in15_min",
		SENSORS_ADM1026_IN15, SENSORS_ADM1026_IN15, RW,
    ...
    { SENSORS_ADM1026_IN16_MIN, "in16_min",
		SENSORS_ADM1026_IN16, SENSORS_ADM1026_IN16, RW,
    ...
    { SENSORS_ADM1026_TEMP1_MIN, "temp1_min",
		SENSORS_ADM1026_TEMP1, SENSORS_ADM1026_TEMP1, RW,
    ...
    { SENSORS_ADM1026_TEMP1_OFFSET, "temp1_offset",
		SENSORS_ADM1026_TEMP1, NOMAP, RW,
    ...
    { SENSORS_ADM1026_TEMP2_MIN, "temp2_min",
		SENSORS_ADM1026_TEMP2, SENSORS_ADM1026_TEMP2, RW,
    ...
    { SENSORS_ADM1026_TEMP2_OFFSET, "temp2_offset",
		SENSORS_ADM1026_TEMP2, NOMAP, RW,
    ...
    { SENSORS_ADM1026_TEMP3_MIN, "temp3_min",
		SENSORS_ADM1026_TEMP3, SENSORS_ADM1026_TEMP3, RW,
    ...
    { SENSORS_ADM1026_TEMP3_OFFSET, "temp3_offset",
		SENSORS_ADM1026_TEMP3, NOMAP, RW,
...
static sensors_chip_feature via686a_features[] =
  { 
    { SENSORS_VIA686A_IN0, "2.0V", NOMAP, NOMAP, 
                        R, VIA686A_SYSCTL_IN0, VALUE(3), 2, "in0_input", 3 },
    { SENSORS_VIA686A_IN1, "2.5V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN1, VALUE(3), 2, "in1_input", 3 },
    { SENSORS_VIA686A_IN2, "3.3V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN2, VALUE(3), 2, "in2_input", 3 },
    { SENSORS_VIA686A_IN3, "5.0V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN3, VALUE(3), 2, "in3_input", 3 },
    { SENSORS_VIA686A_IN4, "12V", NOMAP, NOMAP,
                        R, VIA686A_SYSCTL_IN4, VALUE(3), 2, "in4_input", 3 },
    { SENSORS_VIA686A_IN0_MIN, "in0_min", SENSORS_VIA686A_IN0,
                            SENSORS_VIA686A_IN0,
                            RW, VIA686A_SYSCTL_IN0, VALUE(1), 2 },
    { SENSORS_VIA686A_IN1_MIN, "in1_min", SENSORS_VIA686A_IN1,
                            SENSORS_VIA686A_IN1,
                            RW, VIA686A_SYSCTL_IN1, VALUE(1), 2 },
    { SENSORS_VIA686A_IN2_MIN, "in2_min", SENSORS_VIA686A_IN2,
                            SENSORS_VIA686A_IN2,
                            RW, VIA686A_SYSCTL_IN2, VALUE(1), 2 },
    { SENSORS_VIA686A_IN3_MIN, "in3_min", SENSORS_VIA686A_IN3,
                            SENSORS_VIA686A_IN3,
                            RW, VIA686A_SYSCTL_IN3, VALUE(1), 2 },
    { SENSORS_VIA686A_IN4_MIN, "in4_min", SENSORS_VIA686A_IN4,
                            SENSORS_VIA686A_IN4,
                            RW, VIA686A_SYSCTL_IN4, VALUE(1), 2 },
    { SENSORS_VIA686A_IN0_MAX, "in0_max", SENSORS_VIA686A_IN0,
                            SENSORS_VIA686A_IN0,
                            RW, VIA686A_SYSCTL_IN0, VALUE(2), 2 },
    { SENSORS_VIA686A_IN1_MAX, "in1_max", SENSORS_VIA686A_IN1,
                            SENSORS_VIA686A_IN1,
                            RW, VIA686A_SYSCTL_IN1, VALUE(2), 2 },
    { SENSORS_VIA686A_IN2_MAX, "in2_max", SENSORS_VIA686A_IN2,
                            SENSORS_VIA686A_IN2,
                            RW, VIA686A_SYSCTL_IN2, VALUE(2), 2 },
    { SENSORS_VIA686A_IN3_MAX, "in3_max", SENSORS_VIA686A_IN3,
                            SENSORS_VIA686A_IN3,
                            RW, VIA686A_SYSCTL_IN3, VALUE(2), 2 },
    { SENSORS_VIA686A_IN4_MAX, "in4_max", SENSORS_VIA686A_IN4,
                            SENSORS_VIA686A_IN4,
                            RW, VIA686A_SYSCTL_IN4, VALUE(2), 2 },
    { SENSORS_VIA686A_FAN1, "fan1", NOMAP, NOMAP,
                         R, VIA686A_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_VIA686A_FAN2, "fan2", NOMAP, NOMAP,
                         R, VIA686A_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_VIA686A_FAN1_MIN, "fan1_min", SENSORS_VIA686A_FAN1,
                             SENSORS_VIA686A_FAN1,
                             RW, VIA686A_SYSCTL_FAN1, VALUE(1), 0 },
    { SENSORS_VIA686A_FAN2_MIN, "fan2_min", SENSORS_VIA686A_FAN2,
                             SENSORS_VIA686A_FAN2,
                             RW, VIA686A_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_VIA686A_TEMP, "temp1", NOMAP, NOMAP,
                         R, VIA686A_SYSCTL_TEMP, VALUE(3), 1 },
    ...
    { SENSORS_VIA686A_TEMP2, "temp2", NOMAP, NOMAP,
                         R, VIA686A_SYSCTL_TEMP2, VALUE(3), 1 },
    ...
    { SENSORS_VIA686A_TEMP3, "temp3", NOMAP, NOMAP,
                         R, VIA686A_SYSCTL_TEMP3, VALUE(3), 1 },
    ...
    { SENSORS_VIA686A_FAN1_DIV, "fan1_div", SENSORS_VIA686A_FAN1,
                             NOMAP,
                             RW, VIA686A_SYSCTL_FAN_DIV, VALUE(1), 
                             0 },
...
static sensors_chip_feature ddcmon_features[] =
  {
    { SENSORS_DDCMON_MAN_ID, "Manufacturer ID",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_ID, VALUE(1), 0 },
    { SENSORS_DDCMON_PROD_ID, "Model Number",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_ID, VALUE(2), 0 },
    { SENSORS_DDCMON_VERSIZE, "Monitor Size (cm)",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_SIZE, VALUE(1), 0 },
    { SENSORS_DDCMON_HORSIZE, "hsize",
                         SENSORS_DDCMON_VERSIZE, NOMAP,
                         R, DDCMON_SYSCTL_SIZE, VALUE(2), 0 },
    { SENSORS_DDCMON_VERSYNCMIN, "Vertical Sync (Hz)",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_SYNC, VALUE(1), 0 },
    { SENSORS_DDCMON_VERSYNCMAX, "v_sync_max",
                         SENSORS_DDCMON_VERSYNCMIN, NOMAP,
                         R, DDCMON_SYSCTL_SYNC, VALUE(2), 0 },
    { SENSORS_DDCMON_HORSYNCMIN, "Horizontal Sync (KHz)",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_SYNC, VALUE(3), 0 },
    { SENSORS_DDCMON_HORSYNCMAX, "h_sync_max",
                         SENSORS_DDCMON_HORSYNCMIN, NOMAP,
                         R, DDCMON_SYSCTL_SYNC, VALUE(4), 0 },
    { SENSORS_DDCMON_TIMINGS, "Established Timings",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMINGS, VALUE(1), 0 },
    { SENSORS_DDCMON_SERIAL, "Serial Number",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_SERIAL, VALUE(1), 0 },
    { SENSORS_DDCMON_YEAR, "Manufacture Time",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIME, VALUE(1), 0 },
    { SENSORS_DDCMON_WEEK, "week",
                         SENSORS_DDCMON_YEAR, NOMAP,
                         R, DDCMON_SYSCTL_TIME, VALUE(2), 0 },
    { SENSORS_DDCMON_EDID_VER, "EDID Version",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_EDID, VALUE(1), 0 },
    { SENSORS_DDCMON_EDID_REV, "revision",
                         SENSORS_DDCMON_EDID_VER, NOMAP,
                         R, DDCMON_SYSCTL_EDID, VALUE(2), 0 },
    { SENSORS_DDCMON_GAMMA, "Gamma Factor",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_GAMMA, VALUE(1), 2 },
    { SENSORS_DDCMON_DPMS, "DPMS Modes",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_DPMS, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING1_HOR, "Standard Timing 1",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMING1, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING1_VER, "vertical",
                         SENSORS_DDCMON_TIMING1_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING1, VALUE(2), 0 },
    { SENSORS_DDCMON_TIMING1_REF, "refresh",
                         SENSORS_DDCMON_TIMING1_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING1, VALUE(3), 0 },
    { SENSORS_DDCMON_TIMING2_HOR, "Standard Timing 2",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMING2, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING2_VER, "vertical",
                         SENSORS_DDCMON_TIMING2_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING2, VALUE(2), 0 },
    { SENSORS_DDCMON_TIMING2_REF, "refresh",
                         SENSORS_DDCMON_TIMING2_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING2, VALUE(3), 0 },
    { SENSORS_DDCMON_TIMING3_HOR, "Standard Timing 3",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMING3, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING3_VER, "vertical",
                         SENSORS_DDCMON_TIMING3_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING3, VALUE(2), 0 },
    { SENSORS_DDCMON_TIMING3_REF, "refresh",
                         SENSORS_DDCMON_TIMING3_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING3, VALUE(3), 0 },
    { SENSORS_DDCMON_TIMING4_HOR, "Standard Timing 4",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMING4, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING4_VER, "vertical",
                         SENSORS_DDCMON_TIMING4_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING4, VALUE(2), 0 },
    { SENSORS_DDCMON_TIMING4_REF, "refresh",
                         SENSORS_DDCMON_TIMING4_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING4, VALUE(3), 0 },
    { SENSORS_DDCMON_TIMING5_HOR, "Standard Timing 5",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMING5, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING5_VER, "vertical",
                         SENSORS_DDCMON_TIMING5_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING5, VALUE(2), 0 },
    { SENSORS_DDCMON_TIMING5_REF, "refresh",
                         SENSORS_DDCMON_TIMING5_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING5, VALUE(3), 0 },
    { SENSORS_DDCMON_TIMING6_HOR, "Standard Timing 6",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMING6, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING6_VER, "vertical",
                         SENSORS_DDCMON_TIMING6_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING6, VALUE(2), 0 },
    { SENSORS_DDCMON_TIMING6_REF, "refresh",
                         SENSORS_DDCMON_TIMING6_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING6, VALUE(3), 0 },
    { SENSORS_DDCMON_TIMING7_HOR, "Standard Timing 7",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMING7, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING7_VER, "vertical",
                         SENSORS_DDCMON_TIMING7_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING7, VALUE(2), 0 },
    { SENSORS_DDCMON_TIMING7_REF, "refresh",
                         SENSORS_DDCMON_TIMING7_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING7, VALUE(3), 0 },
    { SENSORS_DDCMON_TIMING8_HOR, "Standard Timing 8",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_TIMING8, VALUE(1), 0 },
    { SENSORS_DDCMON_TIMING8_VER, "vertical",
                         SENSORS_DDCMON_TIMING8_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING8, VALUE(2), 0 },
    { SENSORS_DDCMON_TIMING8_REF, "refresh",
                         SENSORS_DDCMON_TIMING8_HOR, NOMAP,
                         R, DDCMON_SYSCTL_TIMING8, VALUE(3), 0 },
    { SENSORS_DDCMON_MAXCLOCK, "Max Pixel Clock (MHz)",
                         NOMAP, NOMAP,
                         R, DDCMON_SYSCTL_MAXCLOCK, VALUE(1), 0 },
    { 0 }
  };
...
static sensors_chip_feature lm85_features[] =
  { 
    ...
    { SENSORS_LM85_IN5, "in5", NOMAP, NOMAP,
                        R, EMC6D100_SYSCTL_IN5, VALUE(3), 3 },
    { SENSORS_LM85_IN6, "in6", NOMAP, NOMAP,
                        R, EMC6D100_SYSCTL_IN6, VALUE(3), 3 },
...
static sensors_chip_feature lm87_features[] =
  { 
    { SENSORS_LM87_IN0, "2.5V", NOMAP, NOMAP,
                        R, LM87_SYSCTL_IN0, VALUE(3), 2, "in0_input", 3 },
    { SENSORS_LM87_IN1, "Vccp1", NOMAP, NOMAP,
                        R, LM87_SYSCTL_IN1, VALUE(3), 2, "in1_input", 3 },
    { SENSORS_LM87_IN2, "3.3V", NOMAP, NOMAP,
                        R, LM87_SYSCTL_IN2, VALUE(3), 2, "in2_input", 3 },
    { SENSORS_LM87_IN3, "5V", NOMAP, NOMAP,
                        R, LM87_SYSCTL_IN3, VALUE(3), 2, "in3_input", 3 },
    { SENSORS_LM87_IN4, "12V", NOMAP, NOMAP,
                        R, LM87_SYSCTL_IN4, VALUE(3), 2, "in4_input", 3 },
    ...
    { SENSORS_LM87_FAN2, "fan2", NOMAP, NOMAP,
                        R, LM87_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_LM87_FAN1_MIN, "fan1_min", SENSORS_LM87_FAN1,
                        SENSORS_LM87_FAN1, RW, 
    ...
    { SENSORS_LM87_VID, "vid", NOMAP, NOMAP,
                         R, LM87_SYSCTL_VID, VALUE(1), 3 },
    { SENSORS_LM87_VRM, "vrm", NOMAP, NOMAP,
                         RW, LM87_SYSCTL_VRM, VALUE(1), 1 },
/* Ho hum, this will be wrong if fan1 is disabled, but fan2 isn't.. fix?? */
    ...
    { SENSORS_LM87_ALARMS, "alarms", NOMAP, NOMAP, 
...
static sensors_chip_feature mtp008_features[] =
  { 
    { SENSORS_MTP008_IN0, "in0", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_MTP008_IN1, "in1", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_MTP008_IN2, "in2", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_MTP008_IN3, "in3", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_MTP008_IN4, "in4", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_MTP008_IN5, "in5", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_IN5, VALUE(3), 2 },
    { SENSORS_MTP008_IN6, "in6", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_IN6, VALUE(3), 2 },
    ...
    { SENSORS_MTP008_FAN1, "fan1", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_MTP008_FAN2, "fan2", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_MTP008_FAN3, "fan3", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_FAN3, VALUE(2), 0 },
    ...
    { SENSORS_MTP008_TEMP1, "temp1", NOMAP, NOMAP,
                        R, MTP008_SYSCTL_TEMP1, VALUE(3), 1 },
    { SENSORS_MTP008_TEMP2, "temp2", NOMAP, NOMAP, 
    ...
    { SENSORS_MTP008_VID, "vid", NOMAP, NOMAP,
                         R, MTP008_SYSCTL_VID, VALUE(1), 2 },
    { SENSORS_MTP008_FAN1_DIV, "fan1_div", NOMAP, 
                         NOMAP, RW, 
                         MTP008_SYSCTL_FAN_DIV, VALUE(1), 0 },
    { SENSORS_MTP008_FAN2_DIV, "fan2_div", NOMAP, 
                         NOMAP, RW, 
                         MTP008_SYSCTL_FAN_DIV, VALUE(2), 0 },
    { SENSORS_MTP008_FAN3_DIV, "fan3_div", NOMAP, 
                         NOMAP, RW, 
                         MTP008_SYSCTL_FAN_DIV, VALUE(3), 0 },
    { SENSORS_MTP008_ALARMS, "alarms", NOMAP, NOMAP, 
                         R, MTP008_SYSCTL_ALARMS, VALUE(1), 0 },
    { SENSORS_MTP008_BEEP, "beeps", NOMAP, NOMAP, 
                         R, MTP008_SYSCTL_BEEP, VALUE(1), 0 },
    { 0 }
  };

static sensors_chip_feature ds1621_features[] =
  {
    { SENSORS_DS1621_TEMP, "temp", NOMAP, NOMAP,
    ...
    { SENSORS_DS1621_ALARMS, "alarms", NOMAP, NOMAP,
                           R, DS1621_SYSCTL_ALARMS, VALUE(1), 0 },
    { 0 }
  };

static sensors_chip_feature it87_features[] =
  {
    { SENSORS_IT87_IN0, "in0", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_IT87_IN1, "in1", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_IT87_IN2, "in2", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_IT87_IN3, "in3", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_IT87_IN4, "in4", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_IT87_IN5, "in5", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN5, VALUE(3), 2 },
    { SENSORS_IT87_IN6, "in6", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN6, VALUE(3), 2 },
    { SENSORS_IT87_IN7, "in7", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN7, VALUE(3), 2 },
    { SENSORS_IT87_IN8, "in8", NOMAP, NOMAP,
                        R, IT87_SYSCTL_IN8, VALUE(3), 2 },
    { SENSORS_IT87_IN0_MIN, "in0_min", SENSORS_IT87_IN0, SENSORS_IT87_IN0,
                            RW, IT87_SYSCTL_IN0, VALUE(1), 2 },
    { SENSORS_IT87_IN1_MIN, "in1_min", SENSORS_IT87_IN1, SENSORS_IT87_IN1,
                            RW, IT87_SYSCTL_IN1, VALUE(1), 2 },
    { SENSORS_IT87_IN2_MIN, "in2_min", SENSORS_IT87_IN2, SENSORS_IT87_IN2,
                            RW, IT87_SYSCTL_IN2, VALUE(1), 2 },
    { SENSORS_IT87_IN3_MIN, "in3_min", SENSORS_IT87_IN3, SENSORS_IT87_IN3,
                            RW, IT87_SYSCTL_IN3, VALUE(1), 2 },
    { SENSORS_IT87_IN4_MIN, "in4_min", SENSORS_IT87_IN4, SENSORS_IT87_IN4,
                            RW, IT87_SYSCTL_IN4, VALUE(1), 2 },
    { SENSORS_IT87_IN5_MIN, "in5_min", SENSORS_IT87_IN5, SENSORS_IT87_IN5,
                            RW, IT87_SYSCTL_IN5, VALUE(1), 2 },
    { SENSORS_IT87_IN6_MIN, "in6_min", SENSORS_IT87_IN6, SENSORS_IT87_IN6,
                            RW, IT87_SYSCTL_IN6, VALUE(1), 2 },
    { SENSORS_IT87_IN7_MIN, "in7_min", SENSORS_IT87_IN7, SENSORS_IT87_IN7,
                            RW, IT87_SYSCTL_IN7, VALUE(1), 2 },
    { SENSORS_IT87_IN0_MAX, "in0_max", SENSORS_IT87_IN0, SENSORS_IT87_IN0,
                            RW, IT87_SYSCTL_IN0, VALUE(2), 2 },
    { SENSORS_IT87_IN1_MAX, "in1_max", SENSORS_IT87_IN1, SENSORS_IT87_IN1,
                            RW, IT87_SYSCTL_IN1, VALUE(2), 2 },
    { SENSORS_IT87_IN2_MAX, "in2_max", SENSORS_IT87_IN2, SENSORS_IT87_IN2,
                            RW, IT87_SYSCTL_IN2, VALUE(2), 2 },
    { SENSORS_IT87_IN3_MAX, "in3_max", SENSORS_IT87_IN3, SENSORS_IT87_IN3,
                            RW, IT87_SYSCTL_IN3, VALUE(2), 2 },
    { SENSORS_IT87_IN4_MAX, "in4_max", SENSORS_IT87_IN4, SENSORS_IT87_IN4,
                            RW, IT87_SYSCTL_IN4, VALUE(2), 2 },
    { SENSORS_IT87_IN5_MAX, "in5_max", SENSORS_IT87_IN5, SENSORS_IT87_IN5,
                            RW, IT87_SYSCTL_IN5, VALUE(2), 2 },
    { SENSORS_IT87_IN6_MAX, "in6_max", SENSORS_IT87_IN6, SENSORS_IT87_IN6,
                            RW, IT87_SYSCTL_IN6, VALUE(2), 2 },
    { SENSORS_IT87_IN7_MAX, "in7_max", SENSORS_IT87_IN7, SENSORS_IT87_IN7,
                            RW, IT87_SYSCTL_IN7, VALUE(2), 2 },
    { SENSORS_IT87_FAN1, "fan1", NOMAP, NOMAP,
                         R, IT87_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_IT87_FAN2, "fan2", NOMAP, NOMAP,
                         R, IT87_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_IT87_FAN3, "fan3", NOMAP, NOMAP,
                         R, IT87_SYSCTL_FAN3, VALUE(2), 0 },
    { SENSORS_IT87_FAN1_MIN, "fan1_min", SENSORS_IT87_FAN1, SENSORS_IT87_FAN1,
                             RW, IT87_SYSCTL_FAN1, VALUE(1), 0 },
    { SENSORS_IT87_FAN2_MIN, "fan2_min", SENSORS_IT87_FAN2, SENSORS_IT87_FAN2,
                             RW, IT87_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_IT87_FAN3_MIN, "fan3_min", SENSORS_IT87_FAN3, SENSORS_IT87_FAN3,
                             RW, IT87_SYSCTL_FAN3, VALUE(1), 0 },
    { SENSORS_IT87_TEMP1, "temp1", NOMAP, NOMAP,
                         R, IT87_SYSCTL_TEMP1, VALUE(3), 1 },
    { SENSORS_IT87_TEMP2, "temp2", NOMAP, NOMAP,
    ...
    { SENSORS_IT87_VID, "vid", NOMAP, NOMAP,
                        R, IT87_SYSCTL_VID, VALUE(1), 2 },
    { SENSORS_IT87_FAN1_DIV, "fan1_div", SENSORS_IT87_FAN1, NOMAP,
                             RW, IT87_SYSCTL_FAN_DIV, VALUE(1),
                             0 },
    { SENSORS_IT87_FAN2_DIV, "fan2_div", SENSORS_IT87_FAN2, NOMAP,
                             RW, IT87_SYSCTL_FAN_DIV, VALUE(2),
                             0 },
    { SENSORS_IT87_FAN3_DIV, "fan3_div", SENSORS_IT87_FAN3, NOMAP,
    ...
    { SENSORS_IT87_SENS2, "sensor2", NOMAP, NOMAP,
                         RW, IT87_SYSCTL_SENS2, VALUE(1), 0 },
    { SENSORS_IT87_SENS3, "sensor3", NOMAP, NOMAP,
                         RW, IT87_SYSCTL_SENS3, VALUE(1), 0 },
    { 0 }
  };

static sensors_chip_feature fscpos_features[] =
  {
    { SENSORS_FSCPOS_REV, "rev", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_REV, VALUE(1), 0 },
    { SENSORS_FSCPOS_EVENT, "event", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_EVENT, VALUE(1), 0 },
    { SENSORS_FSCPOS_CONTROL, "control", NOMAP, NOMAP,
                        RW, FSCPOS_SYSCTL_CONTROL, VALUE(1), 0 },
    { SENSORS_FSCPOS_VOLTAGE1, "volt12", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_VOLT0, VALUE(1), 2, "in0_input", 3 },
    { SENSORS_FSCPOS_VOLTAGE2, "volt5", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_VOLT1, VALUE(1), 2, "in1_input", 3 },
    { SENSORS_FSCPOS_VOLTAGE3, "voltbatt", NOMAP, NOMAP,
			R, FSCPOS_SYSCTL_VOLT2, VALUE(1), 2, "in2_input", 3 },
    { SENSORS_FSCPOS_TEMP1, "temp1", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_TEMP0, VALUE(2), 0 },
    { SENSORS_FSCPOS_TEMP2, "temp2", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_TEMP1, VALUE(2), 0 },
    { SENSORS_FSCPOS_TEMP3, "temp3", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_TEMP2, VALUE(2), 0 },
    ...
    { SENSORS_FSCPOS_FAN1, "fan1", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_FAN0, VALUE(4), 0 },
    { SENSORS_FSCPOS_FAN2, "fan2", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_FAN1, VALUE(4), 0 },
    { SENSORS_FSCPOS_FAN3, "fan3", NOMAP, NOMAP,
                        R, FSCPOS_SYSCTL_FAN2, VALUE(4), 0 },
    ...
    { SENSORS_FSCPOS_WDOG_PRESET, "wdog_preset", NOMAP, 
			NOMAP, RW, 
...
static sensors_chip_feature fscscy_features[] =
  {
    { SENSORS_FSCSCY_REV, "rev", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_REV, VALUE(1), 0 },
    { SENSORS_FSCSCY_EVENT, "event", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_EVENT, VALUE(1), 0 },
    { SENSORS_FSCSCY_CONTROL, "control", NOMAP, NOMAP,
                        RW, FSCSCY_SYSCTL_CONTROL, VALUE(1), 0 },
    { SENSORS_FSCSCY_VOLTAGE1, "volt12", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_VOLT0, VALUE(1), 2 },
    { SENSORS_FSCSCY_VOLTAGE2, "volt5", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_VOLT1, VALUE(1), 2 },
    { SENSORS_FSCSCY_VOLTAGE3, "voltbatt", NOMAP,
			NOMAP, R, 
			FSCSCY_SYSCTL_VOLT2, VALUE(1), 2 },
    { SENSORS_FSCSCY_TEMP1, "temp1", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_TEMP0, VALUE(2), 0 },
    { SENSORS_FSCSCY_TEMP2, "temp2", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_TEMP1, VALUE(2), 0 },
    { SENSORS_FSCSCY_TEMP3, "temp3", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_TEMP2, VALUE(2), 0 },
    { SENSORS_FSCSCY_TEMP4, "temp4", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_TEMP3, VALUE(2), 0 },
    ...
    { SENSORS_FSCSCY_FAN1, "fan1", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_FAN0, VALUE(4), 0 },
    { SENSORS_FSCSCY_FAN2, "fan2", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_FAN1, VALUE(4), 0 },
    { SENSORS_FSCSCY_FAN3, "fan3", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_FAN2, VALUE(4), 0 },
    { SENSORS_FSCSCY_FAN4, "fan4", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_FAN3, VALUE(4), 0 },
    { SENSORS_FSCSCY_FAN5, "fan5", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_FAN4, VALUE(4), 0 },
    { SENSORS_FSCSCY_FAN6, "fan6", NOMAP, NOMAP,
                        R, FSCSCY_SYSCTL_FAN5, VALUE(4), 0 },
    ...
    { SENSORS_FSCSCY_WDOG_PRESET, "wdog_preset", NOMAP, 
			NOMAP, RW, 
  ...
  {
    { SENSORS_FSCHER_REV, "rev", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_REV, VALUE(1), 0 },
    { SENSORS_FSCHER_EVENT, "alarms", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_EVENT, VALUE(1), 0 },
    { SENSORS_FSCHER_CONTROL, "control", NOMAP, NOMAP,
                        RW, FSCHER_SYSCTL_CONTROL, VALUE(1), 0 },
    { SENSORS_FSCHER_VOLTAGE1, "in0", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_VOLT0, VALUE(1), 2 },
    { SENSORS_FSCHER_VOLTAGE2, "in1", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_VOLT1, VALUE(1), 2 },
    { SENSORS_FSCHER_VOLTAGE3, "in2", NOMAP,
			NOMAP, R, 
			FSCHER_SYSCTL_VOLT2, VALUE(1), 2 },
    { SENSORS_FSCHER_TEMP1, "temp1", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_TEMP0, VALUE(2), 0 },
    { SENSORS_FSCHER_TEMP2, "temp2", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_TEMP1, VALUE(2), 0 },
    { SENSORS_FSCHER_TEMP3, "temp3", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_TEMP2, VALUE(2), 0 },
    ...
    { SENSORS_FSCHER_FAN1, "fan1", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_FAN0, VALUE(3), 0 },
    { SENSORS_FSCHER_FAN2, "fan2", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_FAN1, VALUE(3), 0 },
    { SENSORS_FSCHER_FAN3, "fan3", NOMAP, NOMAP,
                        R, FSCHER_SYSCTL_FAN2, VALUE(3), 0 },
    { SENSORS_FSCHER_PWM1, "pwm1", SENSORS_FSCHER_FAN1, 
			NOMAP, RW, 
			FSCHER_SYSCTL_PWM0, VALUE(1), 0 },
    { SENSORS_FSCHER_PWM2, "pwm2", SENSORS_FSCHER_FAN2, 
			NOMAP, RW, 
			FSCHER_SYSCTL_PWM1, VALUE(1), 0 },
    { SENSORS_FSCHER_PWM3, "pwm3", SENSORS_FSCHER_FAN3, 
			NOMAP, RW, 
    ...
    { SENSORS_FSCHER_WDOG_PRESET, "wdog_preset", NOMAP, 
			NOMAP, RW, 
  ...
  static sensors_chip_feature pcf8591_features[] =
  {
    ...
    { SENSORS_PCF8591_CH0, "ch0", NOMAP, NOMAP,
                      R, PCF8591_SYSCTL_CH0, VALUE(1), 2, "in0_input", 3 },
    { SENSORS_PCF8591_CH1, "ch1", NOMAP, NOMAP,
                      R, PCF8591_SYSCTL_CH1, VALUE(1), 2, "in1_input", 3 },
    { SENSORS_PCF8591_CH2, "ch2", NOMAP, NOMAP,
                      R, PCF8591_SYSCTL_CH2, VALUE(1), 2, "in2_input", 3 },
    { SENSORS_PCF8591_CH3, "ch3", NOMAP, NOMAP,
                      R, PCF8591_SYSCTL_CH3, VALUE(1), 2, "in3_input", 3 },
    ...
    { SENSORS_PCF8591_AOUT, "aout", NOMAP, NOMAP,
                      RW, PCF8591_SYSCTL_AOUT, VALUE(1), 2, "out0_output", 3 },
    { 0 }
  };
...
static sensors_chip_feature vt1211_features[] =
  { 
    { SENSORS_VT1211_IN0, "in0", NOMAP, NOMAP, 
                        R, VT1211_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_VT1211_IN1, "in1", NOMAP, NOMAP,
                        R, VT1211_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_VT1211_IN2, "in2", NOMAP, NOMAP,
                        R, VT1211_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_VT1211_IN3, "in3", NOMAP, NOMAP,
                        R, VT1211_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_VT1211_IN4, "in4", NOMAP, NOMAP,
                        R, VT1211_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_VT1211_IN5, "in5", NOMAP, NOMAP,
                        R, VT1211_SYSCTL_IN5, VALUE(3), 2 },
    { SENSORS_VT1211_IN0_MIN, "in0_min", SENSORS_VT1211_IN0,
                            SENSORS_VT1211_IN0,
                            RW, VT1211_SYSCTL_IN0, VALUE(1), 2 },
    { SENSORS_VT1211_IN1_MIN, "in1_min", SENSORS_VT1211_IN1,
                            SENSORS_VT1211_IN1,
                            RW, VT1211_SYSCTL_IN1, VALUE(1), 2 },
    { SENSORS_VT1211_IN2_MIN, "in2_min", SENSORS_VT1211_IN2,
                            SENSORS_VT1211_IN2,
                            RW, VT1211_SYSCTL_IN2, VALUE(1), 2 },
    { SENSORS_VT1211_IN3_MIN, "in3_min", SENSORS_VT1211_IN3,
                            SENSORS_VT1211_IN3,
                            RW, VT1211_SYSCTL_IN3, VALUE(1), 2 },
    { SENSORS_VT1211_IN4_MIN, "in4_min", SENSORS_VT1211_IN4,
                            SENSORS_VT1211_IN4,
                            RW, VT1211_SYSCTL_IN4, VALUE(1), 2 },
    { SENSORS_VT1211_IN5_MIN, "in5_min", SENSORS_VT1211_IN5,
                            SENSORS_VT1211_IN5,
                            RW, VT1211_SYSCTL_IN5, VALUE(1), 2 },
    { SENSORS_VT1211_IN0_MAX, "in0_max", SENSORS_VT1211_IN0,
                            SENSORS_VT1211_IN0,
                            RW, VT1211_SYSCTL_IN0, VALUE(2), 2 },
    { SENSORS_VT1211_IN1_MAX, "in1_max", SENSORS_VT1211_IN1,
                            SENSORS_VT1211_IN1,
                            RW, VT1211_SYSCTL_IN1, VALUE(2), 2 },
    { SENSORS_VT1211_IN2_MAX, "in2_max", SENSORS_VT1211_IN2,
                            SENSORS_VT1211_IN2,
                            RW, VT1211_SYSCTL_IN2, VALUE(2), 2 },
    { SENSORS_VT1211_IN3_MAX, "in3_max", SENSORS_VT1211_IN3,
                            SENSORS_VT1211_IN3,
                            RW, VT1211_SYSCTL_IN3, VALUE(2), 2 },
    { SENSORS_VT1211_IN4_MAX, "in4_max", SENSORS_VT1211_IN4,
                            SENSORS_VT1211_IN4,
                            RW, VT1211_SYSCTL_IN4, VALUE(2), 2 },
    { SENSORS_VT1211_IN5_MAX, "in5_max", SENSORS_VT1211_IN5,
                            SENSORS_VT1211_IN5,
                            RW, VT1211_SYSCTL_IN5, VALUE(2), 2 },
    { SENSORS_VT1211_FAN1, "fan1", NOMAP, NOMAP,
                         R, VT1211_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_VT1211_FAN2, "fan2", NOMAP, NOMAP,
                         R, VT1211_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_VT1211_FAN1_MIN, "fan1_min", SENSORS_VT1211_FAN1,
                             SENSORS_VT1211_FAN1,
                             RW, VT1211_SYSCTL_FAN1, VALUE(1), 0 },
    { SENSORS_VT1211_FAN2_MIN, "fan2_min", SENSORS_VT1211_FAN2,
                             SENSORS_VT1211_FAN2,
                             RW, VT1211_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_VT1211_TEMP1, "temp1", NOMAP, NOMAP,
                         R, VT1211_SYSCTL_TEMP1, VALUE(3), 1 },
    ...
    { SENSORS_VT1211_TEMP2, "temp2", NOMAP, NOMAP,
                         R, VT1211_SYSCTL_TEMP2, VALUE(3), 1 },
    ...
    { SENSORS_VT1211_FAN2_DIV, "fan2_div", SENSORS_VT1211_FAN2,
                             NOMAP,
                             RW, VT1211_SYSCTL_FAN_DIV, VALUE(2), 
                             0 },
    { SENSORS_VT1211_ALARMS, "alarms", NOMAP, NOMAP, 
                           R, VT1211_SYSCTL_ALARMS, VALUE(1), 0 },
    { SENSORS_VT1211_VID, "vid", NOMAP, NOMAP, 
                           R, VT1211_SYSCTL_VID, VALUE(1), 3 },
...
static sensors_chip_feature smsc47m1_features[] =
  { 
    { SENSORS_SMSC47M1_FAN1, "fan1", NOMAP, NOMAP,
                         R, SMSC47M1_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_SMSC47M1_FAN2, "fan2", NOMAP, NOMAP,
                         R, SMSC47M1_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_SMSC47M1_FAN1_MIN, "fan1_min", SENSORS_SMSC47M1_FAN1,
                             SENSORS_SMSC47M1_FAN1,
                             RW, SMSC47M1_SYSCTL_FAN1, VALUE(1), 0 },
    { SENSORS_SMSC47M1_FAN2_MIN, "fan2_min", SENSORS_SMSC47M1_FAN2,
                             SENSORS_SMSC47M1_FAN2,
                             RW, SMSC47M1_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_SMSC47M1_FAN1_DIV, "fan1_div", SENSORS_SMSC47M1_FAN1,
                             NOMAP,
                             RW, SMSC47M1_SYSCTL_FAN_DIV, VALUE(1), 
                             0 },
    { SENSORS_SMSC47M1_FAN2_DIV, "fan2_div", SENSORS_SMSC47M1_FAN2,
                             NOMAP,
                             RW, SMSC47M1_SYSCTL_FAN_DIV, VALUE(2), 
                             0 },
    { SENSORS_SMSC47M1_ALARMS, "alarms", NOMAP, NOMAP, 
...
static sensors_chip_feature pc87360_features[] =
  { 
    ...
    { SENSORS_PC87360_FAN1_MIN, "fan1_min", SENSORS_PC87360_FAN1,
                SENSORS_PC87360_FAN1, RW, PC87360_SYSCTL_FAN1,
                VALUE(1), 0 },
    { SENSORS_PC87360_FAN2_MIN, "fan2_min", SENSORS_PC87360_FAN2,
                SENSORS_PC87360_FAN2, RW, PC87360_SYSCTL_FAN2,
                VALUE(1), 0 },
    { SENSORS_PC87360_FAN3_MIN, "fan3_min", SENSORS_PC87360_FAN3,
                SENSORS_PC87360_FAN3, RW, PC87360_SYSCTL_FAN3,
                VALUE(1), 0 },
    ...
    { SENSORS_PC87360_FAN3_DIV, "fan3_div", SENSORS_PC87360_FAN3,
                NOMAP, R, PC87360_SYSCTL_FAN_DIV, VALUE(3), 0 },
...
static sensors_chip_feature pc87365_features[] =
  { 
    ...
    { SENSORS_PC87360_IN8_MIN, "in8_min", SENSORS_PC87360_IN8,
                SENSORS_PC87360_IN8, RW, PC87365_SYSCTL_IN8,
                VALUE(1), 3 },
    { SENSORS_PC87360_IN9_MIN, "in9_min", SENSORS_PC87360_IN9,
                SENSORS_PC87360_IN9, RW, PC87365_SYSCTL_IN9,
                VALUE(1), 3 },
    { SENSORS_PC87360_IN10_MIN, "in10_min", SENSORS_PC87360_IN10,
                SENSORS_PC87360_IN10, RW, PC87365_SYSCTL_IN10,
                VALUE(1), 3 },
    ...
    { SENSORS_PC87360_IN10_MAX, "in10_max", SENSORS_PC87360_IN10,
                SENSORS_PC87360_IN10, RW, PC87365_SYSCTL_IN10,
                VALUE(2), 3 },
    { SENSORS_PC87360_IN0_STATUS, "in0_status", SENSORS_PC87360_IN0,
                NOMAP, R, PC87365_SYSCTL_IN0_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN1_STATUS, "in1_status", SENSORS_PC87360_IN1,
                NOMAP, R, PC87365_SYSCTL_IN1_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN2_STATUS, "in2_status", SENSORS_PC87360_IN2,
                NOMAP, R, PC87365_SYSCTL_IN2_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN3_STATUS, "in3_status", SENSORS_PC87360_IN3,
                NOMAP, R, PC87365_SYSCTL_IN3_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN4_STATUS, "in4_status", SENSORS_PC87360_IN4,
                NOMAP, R, PC87365_SYSCTL_IN4_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN5_STATUS, "in5_status", SENSORS_PC87360_IN5,
                NOMAP, R, PC87365_SYSCTL_IN5_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN6_STATUS, "in6_status", SENSORS_PC87360_IN6,
                NOMAP, R, PC87365_SYSCTL_IN6_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN7_STATUS, "in7_status", SENSORS_PC87360_IN7,
                NOMAP, R, PC87365_SYSCTL_IN7_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN8_STATUS, "in8_status", SENSORS_PC87360_IN8,
                NOMAP, R, PC87365_SYSCTL_IN8_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN9_STATUS, "in9_status", SENSORS_PC87360_IN9,
                NOMAP, R, PC87365_SYSCTL_IN0_STATUS, VALUE(1), 0 },
    { SENSORS_PC87360_IN10_STATUS, "in10_status", SENSORS_PC87360_IN10,
                NOMAP, R, PC87365_SYSCTL_IN10_STATUS, VALUE(1), 0 },
...
static sensors_chip_feature pc87427_features[] =
  {
    ...
    { SENSORS_PC87427_FAN(8), "fan8", NOMAP, NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { SENSORS_PC87427_FAN_MIN(1), "fan1_min",
               SENSORS_PC87427_FAN(1), SENSORS_PC87427_FAN(1), RW,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_MIN(2), "fan2_min",
               SENSORS_PC87427_FAN(2), SENSORS_PC87427_FAN(2), RW,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_MIN(3), "fan3_min",
               SENSORS_PC87427_FAN(3), SENSORS_PC87427_FAN(3), RW,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_MIN(4), "fan4_min",
               SENSORS_PC87427_FAN(4), SENSORS_PC87427_FAN(4), RW,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_MIN(5), "fan5_min",
               SENSORS_PC87427_FAN(5), SENSORS_PC87427_FAN(5), RW,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_MIN(6), "fan6_min",
               SENSORS_PC87427_FAN(6), SENSORS_PC87427_FAN(6), RW,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_MIN(7), "fan7_min",
               SENSORS_PC87427_FAN(7), SENSORS_PC87427_FAN(7), RW,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_MIN(8), "fan8_min",
               SENSORS_PC87427_FAN(8), SENSORS_PC87427_FAN(8), RW,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_ALARM(1), "fan1_alarm",
               SENSORS_PC87427_FAN(1), NOMAP, R,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_ALARM(2), "fan2_alarm",
               SENSORS_PC87427_FAN(2), NOMAP, R,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_ALARM(3), "fan3_alarm",
               SENSORS_PC87427_FAN(3), NOMAP, R,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_ALARM(4), "fan4_alarm",
               SENSORS_PC87427_FAN(4), NOMAP, R,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_ALARM(5), "fan5_alarm",
               SENSORS_PC87427_FAN(5), NOMAP, R,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_ALARM(6), "fan6_alarm",
               SENSORS_PC87427_FAN(6), NOMAP, R,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_ALARM(7), "fan7_alarm",
               SENSORS_PC87427_FAN(7), NOMAP, R,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_ALARM(8), "fan8_alarm",
               SENSORS_PC87427_FAN(8), NOMAP, R,
               NOSYSCTL, VALUE(1), 0 },
    { SENSORS_PC87427_FAN_FAULT(1), "fan1_fault",
               SENSORS_PC87427_FAN(1), NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { SENSORS_PC87427_FAN_FAULT(2), "fan2_fault",
               SENSORS_PC87427_FAN(2), NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { SENSORS_PC87427_FAN_FAULT(3), "fan3_fault",
               SENSORS_PC87427_FAN(3), NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { SENSORS_PC87427_FAN_FAULT(4), "fan4_fault",
               SENSORS_PC87427_FAN(4), NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { SENSORS_PC87427_FAN_FAULT(5), "fan5_fault",
               SENSORS_PC87427_FAN(5), NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { SENSORS_PC87427_FAN_FAULT(6), "fan6_fault",
               SENSORS_PC87427_FAN(6), NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { SENSORS_PC87427_FAN_FAULT(7), "fan7_fault",
               SENSORS_PC87427_FAN(7), NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { SENSORS_PC87427_FAN_FAULT(8), "fan8_fault",
               SENSORS_PC87427_FAN(8), NOMAP, R,
               NOSYSCTL, VALUE(2), 0 },
    { 0 }
  };
...
static sensors_chip_feature vt8231_features[] =
  { 
    { SENSORS_VT8231_IN0, "in0", NOMAP, NOMAP, 
                        R, VT8231_SYSCTL_IN0, VALUE(3), 2 },
    { SENSORS_VT8231_IN1, "in1", NOMAP, NOMAP,
                        R, VT8231_SYSCTL_IN1, VALUE(3), 2 },
    { SENSORS_VT8231_IN2, "in2", NOMAP, NOMAP,
                        R, VT8231_SYSCTL_IN2, VALUE(3), 2 },
    { SENSORS_VT8231_IN3, "in3", NOMAP, NOMAP,
                        R, VT8231_SYSCTL_IN3, VALUE(3), 2 },
    { SENSORS_VT8231_IN4, "in4", NOMAP, NOMAP,
                        R, VT8231_SYSCTL_IN4, VALUE(3), 2 },
    { SENSORS_VT8231_IN5, "in5", NOMAP, NOMAP,
                        R, VT8231_SYSCTL_IN5, VALUE(3), 2 },
    { SENSORS_VT8231_IN0_MIN, "in0_min", SENSORS_VT8231_IN0,
                            SENSORS_VT8231_IN0,
                            RW, VT8231_SYSCTL_IN0, VALUE(1), 2 },
    { SENSORS_VT8231_IN1_MIN, "in1_min", SENSORS_VT8231_IN1,
                            SENSORS_VT8231_IN1,
                            RW, VT8231_SYSCTL_IN1, VALUE(1), 2 },
    { SENSORS_VT8231_IN2_MIN, "in2_min", SENSORS_VT8231_IN2,
                            SENSORS_VT8231_IN2,
                            RW, VT8231_SYSCTL_IN2, VALUE(1), 2 },
    { SENSORS_VT8231_IN3_MIN, "in3_min", SENSORS_VT8231_IN3,
                            SENSORS_VT8231_IN3,
                            RW, VT8231_SYSCTL_IN3, VALUE(1), 2 },
    { SENSORS_VT8231_IN4_MIN, "in4_min", SENSORS_VT8231_IN4,
                            SENSORS_VT8231_IN4,
                            RW, VT8231_SYSCTL_IN4, VALUE(1), 2 },
    { SENSORS_VT8231_IN5_MIN, "in5_min", SENSORS_VT8231_IN5,
                            SENSORS_VT8231_IN5,
                            RW, VT8231_SYSCTL_IN5, VALUE(1), 2 },
    { SENSORS_VT8231_IN0_MAX, "in0_max", SENSORS_VT8231_IN0,
                            SENSORS_VT8231_IN0,
                            RW, VT8231_SYSCTL_IN0, VALUE(2), 2 },
    { SENSORS_VT8231_IN1_MAX, "in1_max", SENSORS_VT8231_IN1,
                            SENSORS_VT8231_IN1,
                            RW, VT8231_SYSCTL_IN1, VALUE(2), 2 },
    { SENSORS_VT8231_IN2_MAX, "in2_max", SENSORS_VT8231_IN2,
                            SENSORS_VT8231_IN2,
                            RW, VT8231_SYSCTL_IN2, VALUE(2), 2 },
    { SENSORS_VT8231_IN3_MAX, "in3_max", SENSORS_VT8231_IN3,
                            SENSORS_VT8231_IN3,
                            RW, VT8231_SYSCTL_IN3, VALUE(2), 2 },
    { SENSORS_VT8231_IN4_MAX, "in4_max", SENSORS_VT8231_IN4,
                            SENSORS_VT8231_IN4,
                            RW, VT8231_SYSCTL_IN4, VALUE(2), 2 },
    { SENSORS_VT8231_IN5_MAX, "in5_max", SENSORS_VT8231_IN5,
                            SENSORS_VT8231_IN5,
                            RW, VT8231_SYSCTL_IN5, VALUE(2), 2 },
    { SENSORS_VT8231_FAN1, "fan1", NOMAP, NOMAP,
                         R, VT8231_SYSCTL_FAN1, VALUE(2), 0 },
    { SENSORS_VT8231_FAN2, "fan2", NOMAP, NOMAP,
                         R, VT8231_SYSCTL_FAN2, VALUE(2), 0 },
    { SENSORS_VT8231_FAN1_MIN, "fan1_min", SENSORS_VT8231_FAN1,
                             SENSORS_VT8231_FAN1,
                             RW, VT8231_SYSCTL_FAN1, VALUE(1), 0 },
    { SENSORS_VT8231_FAN2_MIN, "fan2_min", SENSORS_VT8231_FAN2,
                             SENSORS_VT8231_FAN2,
                             RW, VT8231_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_VT8231_TEMP, "temp1", NOMAP, NOMAP,
                         R, VT8231_SYSCTL_TEMP, VALUE(3), 1 },
    ...
    { SENSORS_VT8231_TEMP2, "temp2", NOMAP, NOMAP,
                         R, VT8231_SYSCTL_TEMP2, VALUE(3), 2 },
    ...
    { SENSORS_VT8231_TEMP3, "temp3", NOMAP, NOMAP,
                         R, VT8231_SYSCTL_TEMP3, VALUE(3), 2 },
    ...
    { SENSORS_VT8231_TEMP4, "temp4", NOMAP, NOMAP,
                         R, VT8231_SYSCTL_TEMP4, VALUE(3), 2 },
    ...
    { SENSORS_VT8231_TEMP5, "temp5", NOMAP, NOMAP,
                         R, VT8231_SYSCTL_TEMP5, VALUE(3), 2 },
    ...
    { SENSORS_VT8231_TEMP6, "temp6", NOMAP, NOMAP,
                         R, VT8231_SYSCTL_TEMP6, VALUE(3), 2 },
    ...
    { SENSORS_VT8231_FAN1_DIV, "fan1_div", SENSORS_VT8231_FAN1,
                             NOMAP,
                             RW, VT8231_SYSCTL_FAN_DIV, VALUE(1), 
                             0 },
    { SENSORS_VT8231_FAN2_DIV, "fan2_div", SENSORS_VT8231_FAN2,
                             NOMAP,
                             RW, VT8231_SYSCTL_FAN_DIV, VALUE(2), 
                             0 },
    { SENSORS_VT8231_ALARMS, "alarms", NOMAP, NOMAP, 
                           R, VT8231_SYSCTL_ALARMS, VALUE(1), 0 },
    { SENSORS_VT8231_VID, "vid", NOMAP, NOMAP, 
                           R, VT8231_SYSCTL_VID, VALUE(1), 3 },
...
static sensors_chip_feature bmc_features[] =
  { 
    { SENSORS_BMC_IN1, "in1", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1, VALUE(3), 3 , "in1_input", 3},
    { SENSORS_BMC_IN1_MIN, "in1_min", SENSORS_BMC_IN1,
                            SENSORS_BMC_IN1,
                            RW, BMC_SYSCTL_IN1, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX, "in1_max", SENSORS_BMC_IN1,
                            SENSORS_BMC_IN1,
                            RW, BMC_SYSCTL_IN1, VALUE(2), 3 },
    { SENSORS_BMC_IN1+1, "in2", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+1, VALUE(3), 3 , "in2_input", 3},
    { SENSORS_BMC_IN1_MIN+1, "in2_min", SENSORS_BMC_IN1+1,
                            SENSORS_BMC_IN1+1,
                            RW, BMC_SYSCTL_IN1+1, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+1, "in2_max", SENSORS_BMC_IN1+1,
                            SENSORS_BMC_IN1+1,
                            RW, BMC_SYSCTL_IN1+1, VALUE(2), 3 },
    { SENSORS_BMC_IN1+2, "in3", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+2, VALUE(3), 3 , "in2_input", 3},
    { SENSORS_BMC_IN1_MIN+2, "in3_min", SENSORS_BMC_IN1+2,
                            SENSORS_BMC_IN1+2,
                            RW, BMC_SYSCTL_IN1+2, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+2, "in3_max", SENSORS_BMC_IN1+2,
                            SENSORS_BMC_IN1+2,
                            RW, BMC_SYSCTL_IN1+2, VALUE(2), 3 },
    { SENSORS_BMC_IN1+3, "in4", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+3, VALUE(3), 3 , "in3_input", 3},
    { SENSORS_BMC_IN1_MIN+3, "in4_min", SENSORS_BMC_IN1+3,
                            SENSORS_BMC_IN1+3,
                            RW, BMC_SYSCTL_IN1+3, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+3, "in4_max", SENSORS_BMC_IN1+3,
                            SENSORS_BMC_IN1+3,
                            RW, BMC_SYSCTL_IN1+3, VALUE(2), 3 },
    { SENSORS_BMC_IN1+4, "in5", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+4, VALUE(3), 3 , "in4_input", 3},
    { SENSORS_BMC_IN1_MIN+4, "in5_min", SENSORS_BMC_IN1+4,
                            SENSORS_BMC_IN1+4,
                            RW, BMC_SYSCTL_IN1+4, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+4, "in5_max", SENSORS_BMC_IN1+4,
                            SENSORS_BMC_IN1+4,
                            RW, BMC_SYSCTL_IN1+4, VALUE(2), 3 },
    { SENSORS_BMC_IN1+5, "in6", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+5, VALUE(3), 3 , "in5_input", 3},
    { SENSORS_BMC_IN1_MIN+5, "in6_min", SENSORS_BMC_IN1+5,
                            SENSORS_BMC_IN1+5,
                            RW, BMC_SYSCTL_IN1+5, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+5, "in6_max", SENSORS_BMC_IN1+5,
                            SENSORS_BMC_IN1+5,
                            RW, BMC_SYSCTL_IN1+5, VALUE(2), 3 },
    { SENSORS_BMC_IN1+6, "in7", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+6, VALUE(3), 3 , "in6_input", 3},
    { SENSORS_BMC_IN1_MIN+6, "in7_min", SENSORS_BMC_IN1+6,
                            SENSORS_BMC_IN1+6,
                            RW, BMC_SYSCTL_IN1+6, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+6, "in7_max", SENSORS_BMC_IN1+6,
                            SENSORS_BMC_IN1+6,
                            RW, BMC_SYSCTL_IN1+6, VALUE(2), 3 },

    { SENSORS_BMC_IN1+7, "in8", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+7, VALUE(3), 3 , "in7_input", 3},
    { SENSORS_BMC_IN1_MIN+7, "in8_min", SENSORS_BMC_IN1+7,
                            SENSORS_BMC_IN1+7,
                            RW, BMC_SYSCTL_IN1+7, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+7, "in8_max", SENSORS_BMC_IN1+7,
                            SENSORS_BMC_IN1+7,
                            RW, BMC_SYSCTL_IN1+7, VALUE(2), 3 },
    { SENSORS_BMC_IN1+8, "in9", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+8, VALUE(3), 3 , "in8_input", 3},
    { SENSORS_BMC_IN1_MIN+8, "in9_min", SENSORS_BMC_IN1+8,
                            SENSORS_BMC_IN1+8,
                            RW, BMC_SYSCTL_IN1+8, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+8, "in9_max", SENSORS_BMC_IN1+8,
                            SENSORS_BMC_IN1+8,
                            RW, BMC_SYSCTL_IN1+8, VALUE(2), 3 },
    { SENSORS_BMC_IN1+9, "in10", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+9, VALUE(3), 3 , "in9_input", 3},
    { SENSORS_BMC_IN1_MIN+9, "in10_min", SENSORS_BMC_IN1+9,
                            SENSORS_BMC_IN1+9,
                            RW, BMC_SYSCTL_IN1+9, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+9, "in10_max", SENSORS_BMC_IN1+9,
                            SENSORS_BMC_IN1+9,
                            RW, BMC_SYSCTL_IN1+9, VALUE(2), 3 },
    { SENSORS_BMC_IN1+10, "in11", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+10, VALUE(3), 3 , "in10_input", 3},
    { SENSORS_BMC_IN1_MIN+10, "in11_min", SENSORS_BMC_IN1+10,
                            SENSORS_BMC_IN1+10,
                            RW, BMC_SYSCTL_IN1+10, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+10, "in11_max", SENSORS_BMC_IN1+10,
                            SENSORS_BMC_IN1+10,
                            RW, BMC_SYSCTL_IN1+10, VALUE(2), 3 },
    { SENSORS_BMC_IN1+11, "in12", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+11, VALUE(3), 3 , "in11_input", 3},
    { SENSORS_BMC_IN1_MIN+11, "in12_min", SENSORS_BMC_IN1+11,
                            SENSORS_BMC_IN1+11,
                            RW, BMC_SYSCTL_IN1+11, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+11, "in12_max", SENSORS_BMC_IN1+11,
                            SENSORS_BMC_IN1+11,
                            RW, BMC_SYSCTL_IN1+11, VALUE(2), 3 },
    { SENSORS_BMC_IN1+12, "in13", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+12, VALUE(3), 3 , "in12_input", 3},
    { SENSORS_BMC_IN1_MIN+12, "in13_min", SENSORS_BMC_IN1+12,
                            SENSORS_BMC_IN1+12,
                            RW, BMC_SYSCTL_IN1+12, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+12, "in13_max", SENSORS_BMC_IN1+12,
                            SENSORS_BMC_IN1+12,
                            RW, BMC_SYSCTL_IN1+12, VALUE(2), 3 },
    { SENSORS_BMC_IN1+13, "in14", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+13, VALUE(3), 3 , "in13_input", 3},
    { SENSORS_BMC_IN1_MIN+13, "in14_min", SENSORS_BMC_IN1+13,
                            SENSORS_BMC_IN1+13,
                            RW, BMC_SYSCTL_IN1+13, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+13, "in14_max", SENSORS_BMC_IN1+13,
                            SENSORS_BMC_IN1+13,
                            RW, BMC_SYSCTL_IN1+13, VALUE(2), 3 },
    { SENSORS_BMC_IN1+14, "in15", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+14, VALUE(3), 3 , "in14_input", 3},
    { SENSORS_BMC_IN1_MIN+14, "in15_min", SENSORS_BMC_IN1+14,
                            SENSORS_BMC_IN1+14,
                            RW, BMC_SYSCTL_IN1+14, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+14, "in15_max", SENSORS_BMC_IN1+14,
                            SENSORS_BMC_IN1+14,
                            RW, BMC_SYSCTL_IN1+14, VALUE(2), 3 },
    { SENSORS_BMC_IN1+15, "in16", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+15, VALUE(3), 3 , "in15_input", 3},
    { SENSORS_BMC_IN1_MIN+15, "in16_min", SENSORS_BMC_IN1+15,
                            SENSORS_BMC_IN1+15,
                            RW, BMC_SYSCTL_IN1+15, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+15, "in16_max", SENSORS_BMC_IN1+15,
                            SENSORS_BMC_IN1+15,
                            RW, BMC_SYSCTL_IN1+15, VALUE(2), 3 },
    { SENSORS_BMC_IN1+16, "in17", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+16, VALUE(3), 3 , "in16_input", 3},
    { SENSORS_BMC_IN1_MIN+16, "in17_min", SENSORS_BMC_IN1+16,
                            SENSORS_BMC_IN1+16,
                            RW, BMC_SYSCTL_IN1+16, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+16, "in17_max", SENSORS_BMC_IN1+16,
                            SENSORS_BMC_IN1+16,
                            RW, BMC_SYSCTL_IN1+16, VALUE(2), 3 },
    { SENSORS_BMC_IN1+17, "in18", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+17, VALUE(3), 3, "in17_input", 3 },
    { SENSORS_BMC_IN1_MIN+17, "in18_min", SENSORS_BMC_IN1+17,
                            SENSORS_BMC_IN1+17,
                            RW, BMC_SYSCTL_IN1+17, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+17, "in18_max", SENSORS_BMC_IN1+17,
                            SENSORS_BMC_IN1+17,
                            RW, BMC_SYSCTL_IN1+17, VALUE(2), 3 },
    { SENSORS_BMC_IN1+18, "in19", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+18, VALUE(3), 3 , "in18_input", 3},
    { SENSORS_BMC_IN1_MIN+18, "in19_min", SENSORS_BMC_IN1+18,
                            SENSORS_BMC_IN1+18,
                            RW, BMC_SYSCTL_IN1+18, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+18, "in19_max", SENSORS_BMC_IN1+18,
                            SENSORS_BMC_IN1+18,
                            RW, BMC_SYSCTL_IN1+18, VALUE(2), 3 },
    { SENSORS_BMC_IN1+19, "in20", NOMAP, NOMAP, 
                        R, BMC_SYSCTL_IN1+19, VALUE(3), 3 , "in19_input", 3},
    { SENSORS_BMC_IN1_MIN+19, "in20_min", SENSORS_BMC_IN1+19,
                            SENSORS_BMC_IN1+19,
                            RW, BMC_SYSCTL_IN1+19, VALUE(1), 3 },
    { SENSORS_BMC_IN1_MAX+19, "in20_max", SENSORS_BMC_IN1+19,
                            SENSORS_BMC_IN1+19,
                            RW, BMC_SYSCTL_IN1+19, VALUE(2), 3 },
    { SENSORS_BMC_FAN1, "fan1", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1, VALUE(2), 0, "fan1_input", 0},
    { SENSORS_BMC_FAN1+1, "fan2", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+1, VALUE(2), 0, "fan2_input", 0 },
    { SENSORS_BMC_FAN1+2, "fan3", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+2, VALUE(2), 0, "fan3_input", 0 },
    { SENSORS_BMC_FAN1+3, "fan4", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+3, VALUE(2), 0, "fan4_input", 0 },
    { SENSORS_BMC_FAN1+4, "fan5", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+4, VALUE(2), 0, "fan5_input", 0 },
    { SENSORS_BMC_FAN1+5, "fan6", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+5, VALUE(2), 0, "fan6_input", 0 },
    { SENSORS_BMC_FAN1+6, "fan7", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+6, VALUE(2), 0, "fan7_input", 0 },
    { SENSORS_BMC_FAN1+7, "fan8", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+7, VALUE(2), 0, "fan8_input", 0 },
    { SENSORS_BMC_FAN1+8, "fan9", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+8, VALUE(2), 0, "fan9_input", 0 },
    { SENSORS_BMC_FAN1+9, "fan10", NOMAP, NOMAP,
                         R, BMC_SYSCTL_FAN1+9, VALUE(2), 0, "fan10_input", 0 },
    { SENSORS_BMC_FAN1_MIN, "fan1_min", SENSORS_BMC_FAN1,
                             SENSORS_BMC_FAN1,
                             RW, BMC_SYSCTL_FAN1, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+1, "fan2_min", SENSORS_BMC_FAN1+1,
                             SENSORS_BMC_FAN1+1,
                             RW, BMC_SYSCTL_FAN1+1, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+2, "fan3_min", SENSORS_BMC_FAN1+2,
                             SENSORS_BMC_FAN1+2,
                             RW, BMC_SYSCTL_FAN1+2, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+3, "fan4_min", SENSORS_BMC_FAN1+3,
                             SENSORS_BMC_FAN1+3,
                             RW, BMC_SYSCTL_FAN1+3, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+4, "fan5_min", SENSORS_BMC_FAN1+4,
                             SENSORS_BMC_FAN1+4,
                             RW, BMC_SYSCTL_FAN1+4, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+5, "fan6_min", SENSORS_BMC_FAN1+5,
                             SENSORS_BMC_FAN1+5,
                             RW, BMC_SYSCTL_FAN1+5, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+6, "fan7_min", SENSORS_BMC_FAN1+6,
                             SENSORS_BMC_FAN1+6,
                             RW, BMC_SYSCTL_FAN1+6, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+7, "fan8_min", SENSORS_BMC_FAN1+7,
                             SENSORS_BMC_FAN1+7,
                             RW, BMC_SYSCTL_FAN1+7, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+8, "fan9_min", SENSORS_BMC_FAN1+8,
                             SENSORS_BMC_FAN1+8,
                             RW, BMC_SYSCTL_FAN1+8, VALUE(1), 0 },
    { SENSORS_BMC_FAN1_MIN+9, "fan10_min", SENSORS_BMC_FAN1+9,
                             SENSORS_BMC_FAN1+9,
                             RW, BMC_SYSCTL_FAN1+9, VALUE(1), 0 },
    { SENSORS_BMC_TEMP1, "temp1", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1, VALUE(3), 2 , "temp1_input", 3 },
    { SENSORS_BMC_TEMP1_MIN, "temp1_min", SENSORS_BMC_TEMP1,
                              SENSORS_BMC_TEMP1, RW, 
                              BMC_SYSCTL_TEMP1, VALUE(2), 2 },
    { SENSORS_BMC_TEMP1_MAX, "temp1_max", SENSORS_BMC_TEMP1,
                              SENSORS_BMC_TEMP1, RW, 
                              BMC_SYSCTL_TEMP1, VALUE(1), 2 },
    { SENSORS_BMC_TEMP1+1, "temp2", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+1, VALUE(3), 2 , "temp2_input", 2 },
    ...
    { SENSORS_BMC_TEMP1+2, "temp3", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+2, VALUE(3), 2 , "temp3_input", 2 },
    ...
    { SENSORS_BMC_TEMP1+3, "temp4", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+3, VALUE(3), 2, "temp4_input", 2 },
    ...
    { SENSORS_BMC_TEMP1+4, "temp5", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+4, VALUE(3), 2, "temp5_input", 2 },
    ...
    { SENSORS_BMC_TEMP1+5, "temp6", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+5, VALUE(3), 2, "temp6_input", 2 },
    ...
    { SENSORS_BMC_TEMP1+6, "temp7", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+6, VALUE(3), 2, "temp7_input", 2  },
    ...
    { SENSORS_BMC_TEMP1+7, "temp8", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+7, VALUE(3), 2, "temp8_input", 2  },
    ...
    { SENSORS_BMC_TEMP1+8, "temp9", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+8, VALUE(3), 2, "temp9_input", 2  },
    ...
    { SENSORS_BMC_TEMP1+9, "temp10", NOMAP, NOMAP,
                         R, BMC_SYSCTL_TEMP1+9, VALUE(3), 2, "temp10_input", 2  },
    ...
    { SENSORS_BMC_ALARMS, "alarms", NOMAP, NOMAP, 
                           R, BMC_SYSCTL_ALARMS, VALUE(1), 0 },
    { 0 }
  };

static sensors_chip_feature xeontemp_features[] =
  {
    { SENSORS_XEONTEMP_REMOTE_TEMP, "temp", NOMAP, 
                              NOMAP, R, 
    ...
    { SENSORS_XEONTEMP_ALARMS, "alarms", NOMAP,
                              NOMAP, R,
...
static sensors_chip_feature max1619_features[] =
  {
    ...
    { SENSORS_MAX1619_REMOTE_HYST, "temp2_hyst",
      NOMAP, NOMAP,
      RW, MAX1619_SYSCTL_REMOTE_CRIT, VALUE(2), 0, "temp2_crit_hyst", 3 },
...
static sensors_chip_feature max6650_features[] =
  {
    ...
    { SENSORS_MAX6650_FAN2_TACH, "fan2", NOMAP,
                                 NOMAP, R,
                                 MAX6650_SYSCTL_FAN2, VALUE(1), 0 },
    { SENSORS_MAX6650_FAN3_TACH, "fan3", NOMAP,
                                 NOMAP, R,
                                 MAX6650_SYSCTL_FAN3, VALUE(1), 0 },
    { SENSORS_MAX6650_FAN4_TACH, "fan4", NOMAP,
                                 NOMAP, R,
                                 MAX6650_SYSCTL_FAN4, VALUE(1), 0 },
    { SENSORS_MAX6650_SPEED, "speed", NOMAP,
                                 NOMAP, RW,
...
#define SENSORS_SMSC47B397_TEMP(nr) \
	{ SENSORS_SMSC47B397_TEMP##nr, "temp" #nr, NOMAP, NOMAP, R, 0, \
		VALUE(1), 1 }

#define SENSORS_SMSC47B397_FAN(nr) \
	{ SENSORS_SMSC47B397_FAN##nr, "fan" #nr, NOMAP, NOMAP, R, 0, \
		VALUE(1), 1 }
